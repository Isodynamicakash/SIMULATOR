  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-4-moving-charges-and-magnetism/motion-in-a-magnetic-field" className="text-neutral-400 hover:text-white transition">{"Motion in a Magnetic Field"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Motion in Combined Electric and Magnetic Fields"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Motion in Combined Electric and Magnetic Fields"}</h1>
