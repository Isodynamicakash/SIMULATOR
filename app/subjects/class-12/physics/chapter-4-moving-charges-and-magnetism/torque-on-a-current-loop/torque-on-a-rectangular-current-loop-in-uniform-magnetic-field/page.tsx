  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-4-moving-charges-and-magnetism/torque-on-a-current-loop" className="text-neutral-400 hover:text-white transition">{"Torque on a Current Loop"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Torque on a Rectangular Current Loop in Uniform Magnetic Field"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Torque on a Rectangular Current Loop in Uniform Magnetic Field"}</h1>
