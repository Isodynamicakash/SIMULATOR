  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Magnetic Field due to a Current Element"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Magnetic Field due to a Current Element"}</h1>
<p className="mt-2 text-neutral-400">Choose a subtopic.</p>
        <div className="mt-8 grid gap-3 md:grid-cols-2">
            <Link href="/subjects/class-12/physics/chapter-4-moving-charges-and-magnetism/magnetic-field-due-to-a-current-element/biot-savart-law" className="group rounded-2xl border border-neutral-800 bg-neutral-950/70 p-4 transition hover:-translate-y-0.5 hover:border-neutral-600 hover:bg-neutral-900">
              <div className="text-sm font-semibold text-white">{"Biot-Savart Law"}</div>
