  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-4-moving-charges-and-magnetism/the-moving-coil-galvanometer" className="text-neutral-400 hover:text-white transition">{"The Moving Coil Galvanometer"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Principle of Moving Coil Galvanometer"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Principle of Moving Coil Galvanometer"}</h1>
