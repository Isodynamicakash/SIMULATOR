  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-4-moving-charges-and-magnetism/ampere-s-circuital-law" className="text-neutral-400 hover:text-white transition">{"Ampere's Circuital Law"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Magnetic Field due to a Straight Infinite Current-Carrying Wire"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Magnetic Field due to a Straight Infinite Current-Carrying Wire"}</h1>
