  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-7-alternating-current/power-in-ac-circuit" className="text-neutral-400 hover:text-white transition">{"Power in AC Circuit"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Instantaneous Power"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Instantaneous Power"}</h1>
