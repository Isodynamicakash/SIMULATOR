  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-7-alternating-current/ac-voltage-applied-to-a-series-lcr-circuit" className="text-neutral-400 hover:text-white transition">{"AC Voltage Applied to a Series LCR Circuit"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Phasor Diagram for Series LCR Circuit"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Phasor Diagram for Series LCR Circuit"}</h1>
