  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-5-magnetism-and-matter/magnetisation-and-magnetic-intensity" className="text-neutral-400 hover:text-white transition">{"Magnetisation and Magnetic Intensity"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Intensity of Magnetisation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Intensity of Magnetisation"}</h1>
