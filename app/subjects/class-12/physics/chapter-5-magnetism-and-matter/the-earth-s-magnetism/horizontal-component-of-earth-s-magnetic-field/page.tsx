  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-5-magnetism-and-matter/the-earth-s-magnetism" className="text-neutral-400 hover:text-white transition">{"The Earth's Magnetism"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Horizontal Component of Earth's Magnetic Field"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Horizontal Component of Earth's Magnetic Field"}</h1>
