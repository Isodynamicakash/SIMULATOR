  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-5-magnetism-and-matter/magnetic-properties-of-materials" className="text-neutral-400 hover:text-white transition">{"Magnetic Properties of Materials"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Curie Temperature"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Curie Temperature"}</h1>
