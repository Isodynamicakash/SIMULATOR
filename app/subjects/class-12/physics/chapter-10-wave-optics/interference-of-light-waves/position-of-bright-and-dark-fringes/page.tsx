  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-10-wave-optics/interference-of-light-waves" className="text-neutral-400 hover:text-white transition">{"Interference of Light Waves"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Position of Bright and Dark Fringes"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Position of Bright and Dark Fringes"}</h1>
