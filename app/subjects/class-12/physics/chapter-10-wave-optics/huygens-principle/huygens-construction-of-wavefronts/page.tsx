  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-10-wave-optics/huygens-principle" className="text-neutral-400 hover:text-white transition">{"Huygens Principle"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Huygens Construction of Wavefronts"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Huygens Construction of Wavefronts"}</h1>
