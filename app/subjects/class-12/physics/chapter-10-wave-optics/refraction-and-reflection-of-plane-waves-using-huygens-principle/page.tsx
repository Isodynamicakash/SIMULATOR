  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Refraction and Reflection of Plane Waves Using Huygens Principle"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Refraction and Reflection of Plane Waves Using Huygens Principle"}</h1>
<p className="mt-2 text-neutral-400">Choose a subtopic.</p>
        <div className="mt-8 grid gap-3 md:grid-cols-2">
            <Link href="/subjects/class-12/physics/chapter-10-wave-optics/refraction-and-reflection-of-plane-waves-using-huygens-principle/refraction-of-a-plane-wave" className="group rounded-2xl border border-neutral-800 bg-neutral-950/70 p-4 transition hover:-translate-y-0.5 hover:border-neutral-600 hover:bg-neutral-900">
              <div className="text-sm font-semibold text-white">{"Refraction of a Plane Wave"}</div>
            ...
            <Link href="/subjects/class-12/physics/chapter-10-wave-optics/refraction-and-reflection-of-plane-waves-using-huygens-principle/reflection-of-a-plane-wave" className="group rounded-2xl border border-neutral-800 bg-neutral-950/70 p-4 transition hover:-translate-y-0.5 hover:border-neutral-600 hover:bg-neutral-900">
              <div className="text-sm font-semibold text-white">{"Reflection of a Plane Wave"}</div>
              <div className="mt-3 inline-flex items-center rounded-full border border-neutral-800 bg-neutral-900 px-2.5 py-1 text-[11px] font-medium text-neutral-300 group-hover:border-emerald-500/50 group-hover:bg-emerald-500/10 group-hover:text-emerald-200">
                Open subtopic
              </div>
            </Link>
