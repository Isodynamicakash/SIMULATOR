  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-10-wave-optics/refraction-and-reflection-of-plane-waves-using-huygens-principle" className="text-neutral-400 hover:text-white transition">{"Refraction and Reflection of Plane Waves Using Huygens Principle"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reflection of a Plane Wave"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reflection of a Plane Wave"}</h1>
