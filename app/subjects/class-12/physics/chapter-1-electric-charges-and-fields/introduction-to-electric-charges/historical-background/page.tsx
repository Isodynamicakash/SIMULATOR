  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-1-electric-charges-and-fields/introduction-to-electric-charges" className="text-neutral-400 hover:text-white transition">{"Introduction to Electric Charges"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Historical Background"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Historical Background"}</h1>
