  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/physics/chapter-8-electromagnetic-waves/maxwell-s-equations" className="text-neutral-400 hover:text-white transition">{"Maxwell's Equations"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Faraday's Law of Electromagnetic Induction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Faraday's Law of Electromagnetic Induction"}</h1>
