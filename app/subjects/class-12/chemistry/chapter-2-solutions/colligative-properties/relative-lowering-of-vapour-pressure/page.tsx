...
export const metadata = {
  title: "Relative Lowering of Vapour Pressure | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Relative Lowering of Vapour Pressure - Colligative Properties, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Relative Lowering of Vapour Pressure | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Relative Lowering of Vapour Pressure - Colligative Properties, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-2-solutions/colligative-properties" className="text-neutral-400 hover:text-white transition">{"Colligative Properties"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Relative Lowering of Vapour Pressure"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Relative Lowering of Vapour Pressure"}</h1>
