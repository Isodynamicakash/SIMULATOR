...
export const metadata = {
  title: "Elevation of Boiling Point | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Elevation of Boiling Point - Colligative Properties, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Elevation of Boiling Point | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Elevation of Boiling Point - Colligative Properties, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Elevation of Boiling Point"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Elevation of Boiling Point"}</h1>
