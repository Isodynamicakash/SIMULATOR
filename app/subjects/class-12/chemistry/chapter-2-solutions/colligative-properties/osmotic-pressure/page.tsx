...
export const metadata = {
  title: "Osmotic Pressure | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Osmotic Pressure - Colligative Properties, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Osmotic Pressure | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Osmotic Pressure - Colligative Properties, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Osmotic Pressure"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Osmotic Pressure"}</h1>
