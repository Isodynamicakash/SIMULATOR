...
export const metadata = {
  title: "Depression of Freezing Point | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Depression of Freezing Point - Colligative Properties, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Depression of Freezing Point | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Depression of Freezing Point - Colligative Properties, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Depression of Freezing Point"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Depression of Freezing Point"}</h1>
