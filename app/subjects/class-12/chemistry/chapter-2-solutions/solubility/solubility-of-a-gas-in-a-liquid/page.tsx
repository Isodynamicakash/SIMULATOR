...
export const metadata = {
  title: "Solubility of a Gas in a Liquid | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Solubility of a Gas in a Liquid - Solubility, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Solubility of a Gas in a Liquid | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Solubility of a Gas in a Liquid - Solubility, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Solubility of a Gas in a Liquid"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Solubility of a Gas in a Liquid"}</h1>
