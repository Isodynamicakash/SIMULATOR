...
export const metadata = {
  title: "Effect of Pressure | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Effect of Pressure - Solubility, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Effect of Pressure | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Effect of Pressure - Solubility, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Effect of Pressure"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Effect of Pressure"}</h1>
