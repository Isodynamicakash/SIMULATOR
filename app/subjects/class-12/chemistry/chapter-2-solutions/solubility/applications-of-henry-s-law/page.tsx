...
export const metadata = {
  title: "Applications of Henry's Law | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Applications of Henry's Law - Solubility, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Applications of Henry's Law | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Applications of Henry's Law - Solubility, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Applications of Henry's Law"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Applications of Henry's Law"}</h1>
