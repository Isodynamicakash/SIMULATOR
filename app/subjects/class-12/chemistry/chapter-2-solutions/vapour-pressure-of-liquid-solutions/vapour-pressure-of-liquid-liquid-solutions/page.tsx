...
export const metadata = {
  title: "Vapour Pressure of Liquid-Liquid Solutions | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Vapour Pressure of Liquid-Liquid Solutions - Vapour Pressure of Liquid Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustr",
  openGraph: {
    title: "Vapour Pressure of Liquid-Liquid Solutions | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Vapour Pressure of Liquid-Liquid Solutions - Vapour Pressure of Liquid Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustr",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Vapour Pressure of Liquid-Liquid Solutions"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Vapour Pressure of Liquid-Liquid Solutions"}</h1>
