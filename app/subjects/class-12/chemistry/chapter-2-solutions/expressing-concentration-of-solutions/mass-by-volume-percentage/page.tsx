...
export const metadata = {
  title: "Mass by Volume Percentage | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Mass by Volume Percentage - Expressing Concentration of Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Mass by Volume Percentage | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Mass by Volume Percentage - Expressing Concentration of Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-2-solutions/expressing-concentration-of-solutions" className="text-neutral-400 hover:text-white transition">{"Expressing Concentration of Solutions"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Mass by Volume Percentage"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Mass by Volume Percentage"}</h1>
