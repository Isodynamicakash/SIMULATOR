...
export const metadata = {
  title: "Volume Percentage | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Volume Percentage - Expressing Concentration of Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Volume Percentage | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Volume Percentage - Expressing Concentration of Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Volume Percentage"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Volume Percentage"}</h1>
