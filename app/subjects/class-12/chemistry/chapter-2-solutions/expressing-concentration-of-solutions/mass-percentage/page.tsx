...
export const metadata = {
  title: "Mass Percentage | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Mass Percentage - Expressing Concentration of Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Mass Percentage | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Mass Percentage - Expressing Concentration of Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Mass Percentage"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Mass Percentage"}</h1>
