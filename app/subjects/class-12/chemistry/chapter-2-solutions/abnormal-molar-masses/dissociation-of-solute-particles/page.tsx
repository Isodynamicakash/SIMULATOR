...
export const metadata = {
  title: "Dissociation of Solute Particles | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Dissociation of Solute Particles - Abnormal Molar Masses, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Dissociation of Solute Particles | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Dissociation of Solute Particles - Abnormal Molar Masses, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-2-solutions/abnormal-molar-masses" className="text-neutral-400 hover:text-white transition">{"Abnormal Molar Masses"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Dissociation of Solute Particles"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Dissociation of Solute Particles"}</h1>
