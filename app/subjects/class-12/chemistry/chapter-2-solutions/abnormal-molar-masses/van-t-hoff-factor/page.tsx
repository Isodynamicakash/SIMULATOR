...
export const metadata = {
  title: "Van't Hoff Factor | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Van't Hoff Factor - Abnormal Molar Masses, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Van't Hoff Factor | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Van't Hoff Factor - Abnormal Molar Masses, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Van't Hoff Factor"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Van't Hoff Factor"}</h1>
