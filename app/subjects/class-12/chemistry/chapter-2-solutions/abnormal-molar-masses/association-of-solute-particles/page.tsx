...
export const metadata = {
  title: "Association of Solute Particles | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Association of Solute Particles - Abnormal Molar Masses, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Association of Solute Particles | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Association of Solute Particles - Abnormal Molar Masses, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Association of Solute Particles"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Association of Solute Particles"}</h1>
