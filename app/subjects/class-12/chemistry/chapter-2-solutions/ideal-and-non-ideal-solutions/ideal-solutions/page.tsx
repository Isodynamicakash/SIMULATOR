...
export const metadata = {
  title: "Ideal Solutions | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Ideal Solutions - Ideal and Non-Ideal Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Ideal Solutions | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Ideal Solutions - Ideal and Non-Ideal Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Ideal Solutions"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Ideal Solutions"}</h1>
