...
export const metadata = {
  title: "Negative Deviation from Raoult's Law | Chapter 2: Solutions | Class 12 Chemistry",
  description: "Negative Deviation from Raoult's Law - Ideal and Non-Ideal Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Negative Deviation from Raoult's Law | Chapter 2: Solutions | Class 12 Chemistry",
    description: "Negative Deviation from Raoult's Law - Ideal and Non-Ideal Solutions, Chapter 2: Solutions. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Negative Deviation from Raoult's Law"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Negative Deviation from Raoult's Law"}</h1>
