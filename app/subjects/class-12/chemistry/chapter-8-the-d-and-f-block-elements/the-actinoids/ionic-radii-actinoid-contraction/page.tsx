...
export const metadata = {
  title: "Ionic Radii (Actinoid Contraction) | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Ionic Radii (Actinoid Contraction) - The Actinoids, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Ionic Radii (Actinoid Contraction) | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Ionic Radii (Actinoid Contraction) - The Actinoids, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Ionic Radii (Actinoid Contraction)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Ionic Radii (Actinoid Contraction)"}</h1>
