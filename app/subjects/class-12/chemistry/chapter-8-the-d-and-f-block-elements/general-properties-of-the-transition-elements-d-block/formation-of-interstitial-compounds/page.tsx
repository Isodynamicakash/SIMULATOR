...
export const metadata = {
  title: "Formation of Interstitial Compounds | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Formation of Interstitial Compounds - General Properties of the Transition Elements (d-Block), Chapter 8: The d- and f-Block Elements. Class",
  openGraph: {
    title: "Formation of Interstitial Compounds | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Formation of Interstitial Compounds - General Properties of the Transition Elements (d-Block), Chapter 8: The d- and f-Block Elements. Class",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Formation of Interstitial Compounds"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Formation of Interstitial Compounds"}</h1>
