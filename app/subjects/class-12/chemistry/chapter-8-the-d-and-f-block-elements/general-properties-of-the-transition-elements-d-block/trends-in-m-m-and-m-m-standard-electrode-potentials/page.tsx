...
export const metadata = {
  title: "Trends in M²⁺/M and M³⁺/M²⁺ Standard Electrode Pot | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Trends in M²⁺/M and M³⁺/M²⁺ Standard Electrode Potentials - General Properties of the Transition Elements (d-Block), Chapter 8: The d- and f",
  openGraph: {
    title: "Trends in M²⁺/M and M³⁺/M²⁺ Standard Electrode Pot | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Trends in M²⁺/M and M³⁺/M²⁺ Standard Electrode Potentials - General Properties of the Transition Elements (d-Block), Chapter 8: The d- and f",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Trends in M²⁺/M and M³⁺/M²⁺ Standard Electrode Potentials"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Trends in M²⁺/M and M³⁺/M²⁺ Standard Electrode Potentials"}</h1>
