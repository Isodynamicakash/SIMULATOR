...
export const metadata = {
  title: "Catalytic Properties | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Catalytic Properties - General Properties of the Transition Elements (d-Block), Chapter 8: The d- and f-Block Elements. Class 12 Chemistry n",
  openGraph: {
    title: "Catalytic Properties | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Catalytic Properties - General Properties of the Transition Elements (d-Block), Chapter 8: The d- and f-Block Elements. Class 12 Chemistry n",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Catalytic Properties"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Catalytic Properties"}</h1>
