...
export const metadata = {
  title: "Alloy Formation | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Alloy Formation - General Properties of the Transition Elements (d-Block), Chapter 8: The d- and f-Block Elements. Class 12 Chemistry notes ",
  openGraph: {
    title: "Alloy Formation | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Alloy Formation - General Properties of the Transition Elements (d-Block), Chapter 8: The d- and f-Block Elements. Class 12 Chemistry notes ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Alloy Formation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Alloy Formation"}</h1>
