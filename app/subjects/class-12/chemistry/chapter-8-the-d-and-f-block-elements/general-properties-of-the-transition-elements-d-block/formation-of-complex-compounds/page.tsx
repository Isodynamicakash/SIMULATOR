...
export const metadata = {
  title: "Formation of Complex Compounds | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Formation of Complex Compounds - General Properties of the Transition Elements (d-Block), Chapter 8: The d- and f-Block Elements. Class 12 C",
  openGraph: {
    title: "Formation of Complex Compounds | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Formation of Complex Compounds - General Properties of the Transition Elements (d-Block), Chapter 8: The d- and f-Block Elements. Class 12 C",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Formation of Complex Compounds"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Formation of Complex Compounds"}</h1>
