...
export const metadata = {
  title: "Some Applications of d- and f-Block Elements | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Some Applications of d- and f-Block Elements - Chapter 8: The d- and f-Block Elements. Class 12 Chemistry.",
  openGraph: {
    title: "Some Applications of d- and f-Block Elements | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Some Applications of d- and f-Block Elements - Chapter 8: The d- and f-Block Elements. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Some Applications of d- and f-Block Elements"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Some Applications of d- and f-Block Elements"}</h1>
