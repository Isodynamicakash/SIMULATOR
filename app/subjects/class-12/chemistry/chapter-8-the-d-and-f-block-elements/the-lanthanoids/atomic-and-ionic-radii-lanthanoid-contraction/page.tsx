...
export const metadata = {
  title: "Atomic and Ionic Radii (Lanthanoid Contraction) | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Atomic and Ionic Radii (Lanthanoid Contraction) - The Lanthanoids, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry notes and illu",
  openGraph: {
    title: "Atomic and Ionic Radii (Lanthanoid Contraction) | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Atomic and Ionic Radii (Lanthanoid Contraction) - The Lanthanoids, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry notes and illu",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-8-the-d-and-f-block-elements/the-lanthanoids" className="text-neutral-400 hover:text-white transition">{"The Lanthanoids"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Atomic and Ionic Radii (Lanthanoid Contraction)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Atomic and Ionic Radii (Lanthanoid Contraction)"}</h1>
