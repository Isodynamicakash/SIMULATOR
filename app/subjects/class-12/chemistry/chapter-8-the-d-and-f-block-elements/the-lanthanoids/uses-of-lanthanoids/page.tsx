...
export const metadata = {
  title: "Uses of Lanthanoids | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Uses of Lanthanoids - The Lanthanoids, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Uses of Lanthanoids | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Uses of Lanthanoids - The Lanthanoids, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Uses of Lanthanoids"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Uses of Lanthanoids"}</h1>
