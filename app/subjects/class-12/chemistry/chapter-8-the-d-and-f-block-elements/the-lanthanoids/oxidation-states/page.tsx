...
export const metadata = {
  title: "Oxidation States | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Oxidation States - The Lanthanoids, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Oxidation States | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Oxidation States - The Lanthanoids, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Oxidation States"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Oxidation States"}</h1>
