...
export const metadata = {
  title: "Position in the Periodic Table | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Position in the Periodic Table - Chapter 8: The d- and f-Block Elements. Class 12 Chemistry.",
  openGraph: {
    title: "Position in the Periodic Table | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Position in the Periodic Table - Chapter 8: The d- and f-Block Elements. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Position in the Periodic Table"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Position in the Periodic Table"}</h1>
