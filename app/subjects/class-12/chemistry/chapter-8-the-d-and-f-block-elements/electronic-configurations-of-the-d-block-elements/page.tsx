...
export const metadata = {
  title: "Electronic Configurations of the d-Block Elements | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Electronic Configurations of the d-Block Elements - Chapter 8: The d- and f-Block Elements. Class 12 Chemistry.",
  openGraph: {
    title: "Electronic Configurations of the d-Block Elements | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Electronic Configurations of the d-Block Elements - Chapter 8: The d- and f-Block Elements. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Electronic Configurations of the d-Block Elements"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Electronic Configurations of the d-Block Elements"}</h1>
