...
export const metadata = {
  title: "Oxides and Oxoanions of Metals | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Oxides and Oxoanions of Metals - Some Important Compounds of Transition Elements, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry",
  openGraph: {
    title: "Oxides and Oxoanions of Metals | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Oxides and Oxoanions of Metals - Some Important Compounds of Transition Elements, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-8-the-d-and-f-block-elements/some-important-compounds-of-transition-elements" className="text-neutral-400 hover:text-white transition">{"Some Important Compounds of Transition Elements"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Oxides and Oxoanions of Metals"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Oxides and Oxoanions of Metals"}</h1>
