...
export const metadata = {
  title: "Potassium Dichromate (K₂Cr₂O₇) | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
  description: "Potassium Dichromate (K₂Cr₂O₇) - Some Important Compounds of Transition Elements, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry",
  openGraph: {
    title: "Potassium Dichromate (K₂Cr₂O₇) | Chapter 8: The d- and f-Block Elements | Class 12 Chemistry",
    description: "Potassium Dichromate (K₂Cr₂O₇) - Some Important Compounds of Transition Elements, Chapter 8: The d- and f-Block Elements. Class 12 Chemistry",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Potassium Dichromate (K₂Cr₂O₇)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Potassium Dichromate (K₂Cr₂O₇)"}</h1>
