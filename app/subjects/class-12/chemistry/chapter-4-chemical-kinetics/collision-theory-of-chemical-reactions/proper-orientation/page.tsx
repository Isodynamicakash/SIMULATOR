...
export const metadata = {
  title: "Proper Orientation | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Proper Orientation - Collision Theory of Chemical Reactions, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Proper Orientation | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Proper Orientation - Collision Theory of Chemical Reactions, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Proper Orientation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Proper Orientation"}</h1>
