...
export const metadata = {
  title: "First Order Reactions | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "First Order Reactions - Integrated Rate Equations, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "First Order Reactions | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "First Order Reactions - Integrated Rate Equations, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"First Order Reactions"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"First Order Reactions"}</h1>
