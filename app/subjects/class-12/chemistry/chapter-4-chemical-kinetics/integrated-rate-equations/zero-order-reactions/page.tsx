...
export const metadata = {
  title: "Zero Order Reactions | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Zero Order Reactions - Integrated Rate Equations, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Zero Order Reactions | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Zero Order Reactions - Integrated Rate Equations, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Zero Order Reactions"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Zero Order Reactions"}</h1>
