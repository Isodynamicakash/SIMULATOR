...
export const metadata = {
  title: "Half-Life of a Reaction | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Half-Life of a Reaction - Integrated Rate Equations, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Half-Life of a Reaction | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Half-Life of a Reaction - Integrated Rate Equations, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-4-chemical-kinetics/integrated-rate-equations" className="text-neutral-400 hover:text-white transition">{"Integrated Rate Equations"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Half-Life of a Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Half-Life of a Reaction"}</h1>
