...
export const metadata = {
  title: "Instantaneous Rate of Reaction | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Instantaneous Rate of Reaction - Rate of a Chemical Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Instantaneous Rate of Reaction | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Instantaneous Rate of Reaction - Rate of a Chemical Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-4-chemical-kinetics/rate-of-a-chemical-reaction" className="text-neutral-400 hover:text-white transition">{"Rate of a Chemical Reaction"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Instantaneous Rate of Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Instantaneous Rate of Reaction"}</h1>
