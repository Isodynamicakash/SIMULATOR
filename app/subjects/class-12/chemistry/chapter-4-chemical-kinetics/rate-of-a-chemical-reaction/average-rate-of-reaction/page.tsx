...
export const metadata = {
  title: "Average Rate of Reaction | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Average Rate of Reaction - Rate of a Chemical Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Average Rate of Reaction | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Average Rate of Reaction - Rate of a Chemical Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Average Rate of Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Average Rate of Reaction"}</h1>
