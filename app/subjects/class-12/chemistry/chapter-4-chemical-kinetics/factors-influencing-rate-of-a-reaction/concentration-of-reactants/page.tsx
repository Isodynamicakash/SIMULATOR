...
export const metadata = {
  title: "Concentration of Reactants | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Concentration of Reactants - Factors Influencing Rate of a Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustration",
  openGraph: {
    title: "Concentration of Reactants | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Concentration of Reactants - Factors Influencing Rate of a Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustration",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Concentration of Reactants"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Concentration of Reactants"}</h1>
