...
export const metadata = {
  title: "Surface Area | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Surface Area - Factors Influencing Rate of a Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Surface Area | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Surface Area - Factors Influencing Rate of a Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Surface Area"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Surface Area"}</h1>
