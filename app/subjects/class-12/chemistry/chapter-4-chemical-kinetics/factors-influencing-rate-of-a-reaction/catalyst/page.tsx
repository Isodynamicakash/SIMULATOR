...
export const metadata = {
  title: "Catalyst | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Catalyst - Factors Influencing Rate of a Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Catalyst | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Catalyst - Factors Influencing Rate of a Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Catalyst"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Catalyst"}</h1>
