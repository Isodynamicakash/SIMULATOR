...
export const metadata = {
  title: "Pseudo First Order Reaction | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Pseudo First Order Reaction - Chapter 4: Chemical Kinetics. Class 12 Chemistry.",
  openGraph: {
    title: "Pseudo First Order Reaction | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Pseudo First Order Reaction - Chapter 4: Chemical Kinetics. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Pseudo First Order Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Pseudo First Order Reaction"}</h1>
