...
export const metadata = {
  title: "Activation Energy | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Activation Energy - Temperature Dependence of the Rate of a Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustratio",
  openGraph: {
    title: "Activation Energy | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Activation Energy - Temperature Dependence of the Rate of a Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustratio",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Activation Energy"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Activation Energy"}</h1>
