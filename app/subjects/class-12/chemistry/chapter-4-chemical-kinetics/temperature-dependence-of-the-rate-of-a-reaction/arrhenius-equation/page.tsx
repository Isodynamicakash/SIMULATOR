...
export const metadata = {
  title: "Arrhenius Equation | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
  description: "Arrhenius Equation - Temperature Dependence of the Rate of a Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrati",
  openGraph: {
    title: "Arrhenius Equation | Chapter 4: Chemical Kinetics | Class 12 Chemistry",
    description: "Arrhenius Equation - Temperature Dependence of the Rate of a Reaction, Chapter 4: Chemical Kinetics. Class 12 Chemistry notes and illustrati",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Arrhenius Equation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Arrhenius Equation"}</h1>
