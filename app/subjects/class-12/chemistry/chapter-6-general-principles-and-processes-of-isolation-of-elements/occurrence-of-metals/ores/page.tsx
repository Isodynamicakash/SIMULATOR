...
export const metadata = {
  title: "Ores | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Ores - Occurrence of Metals, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illustration",
  openGraph: {
    title: "Ores | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Ores - Occurrence of Metals, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illustration",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Ores"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Ores"}</h1>
