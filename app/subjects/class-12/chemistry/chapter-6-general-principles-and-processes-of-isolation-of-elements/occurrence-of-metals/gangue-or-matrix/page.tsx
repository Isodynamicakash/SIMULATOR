...
export const metadata = {
  title: "Gangue or Matrix | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Gangue or Matrix - Occurrence of Metals, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and ",
  openGraph: {
    title: "Gangue or Matrix | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Gangue or Matrix - Occurrence of Metals, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-6-general-principles-and-processes-of-isolation-of-elements/occurrence-of-metals" className="text-neutral-400 hover:text-white transition">{"Occurrence of Metals"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Gangue or Matrix"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Gangue or Matrix"}</h1>
