...
export const metadata = {
  title: "Hydraulic Washing | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Hydraulic Washing - Concentration of Ores, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes an",
  openGraph: {
    title: "Hydraulic Washing | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Hydraulic Washing - Concentration of Ores, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes an",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Hydraulic Washing"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Hydraulic Washing"}</h1>
