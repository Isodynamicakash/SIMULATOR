...
export const metadata = {
  title: "Froth Flotation Method | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Froth Flotation Method - Concentration of Ores, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry not",
  openGraph: {
    title: "Froth Flotation Method | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Froth Flotation Method - Concentration of Ores, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry not",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-6-general-principles-and-processes-of-isolation-of-elements/concentration-of-ores" className="text-neutral-400 hover:text-white transition">{"Concentration of Ores"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Froth Flotation Method"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Froth Flotation Method"}</h1>
