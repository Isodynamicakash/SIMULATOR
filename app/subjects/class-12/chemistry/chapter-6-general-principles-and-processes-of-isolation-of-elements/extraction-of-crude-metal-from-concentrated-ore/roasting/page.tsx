...
export const metadata = {
  title: "Roasting | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Roasting - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 C",
  openGraph: {
    title: "Roasting | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Roasting - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 C",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Roasting"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Roasting"}</h1>
