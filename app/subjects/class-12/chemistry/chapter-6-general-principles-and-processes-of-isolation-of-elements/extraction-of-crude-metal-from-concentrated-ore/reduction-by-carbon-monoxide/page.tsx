...
export const metadata = {
  title: "Reduction by Carbon Monoxide | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Reduction by Carbon Monoxide - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of ",
  openGraph: {
    title: "Reduction by Carbon Monoxide | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Reduction by Carbon Monoxide - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reduction by Carbon Monoxide"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reduction by Carbon Monoxide"}</h1>
