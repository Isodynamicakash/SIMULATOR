...
export const metadata = {
  title: "Reduction by Carbon | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Reduction by Carbon - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of Elements.",
  openGraph: {
    title: "Reduction by Carbon | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Reduction by Carbon - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of Elements.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reduction by Carbon"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reduction by Carbon"}</h1>
