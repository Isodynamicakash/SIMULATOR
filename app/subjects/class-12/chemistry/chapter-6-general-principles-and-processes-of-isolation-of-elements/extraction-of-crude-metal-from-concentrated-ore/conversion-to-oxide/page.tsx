...
export const metadata = {
  title: "Conversion to Oxide | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Conversion to Oxide - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of Elements.",
  openGraph: {
    title: "Conversion to Oxide | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Conversion to Oxide - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of Elements.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Conversion to Oxide"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Conversion to Oxide"}</h1>
