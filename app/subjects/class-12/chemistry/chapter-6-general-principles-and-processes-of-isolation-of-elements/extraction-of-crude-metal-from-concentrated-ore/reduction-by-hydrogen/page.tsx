...
export const metadata = {
  title: "Reduction by Hydrogen | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Reduction by Hydrogen - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of Element",
  openGraph: {
    title: "Reduction by Hydrogen | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Reduction by Hydrogen - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of Element",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reduction by Hydrogen"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reduction by Hydrogen"}</h1>
