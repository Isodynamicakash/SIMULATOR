...
export const metadata = {
  title: "Calcination | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Calcination - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of Elements. Class 1",
  openGraph: {
    title: "Calcination | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Calcination - Extraction of Crude Metal from Concentrated Ore, Chapter 6: General Principles and Processes of Isolation of Elements. Class 1",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Calcination"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Calcination"}</h1>
