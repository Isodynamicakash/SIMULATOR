...
export const metadata = {
  title: "Limitations of Ellingham Diagram | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Limitations of Ellingham Diagram - Thermodynamic Principles of Metallurgy, Chapter 6: General Principles and Processes of Isolation of Eleme",
  openGraph: {
    title: "Limitations of Ellingham Diagram | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Limitations of Ellingham Diagram - Thermodynamic Principles of Metallurgy, Chapter 6: General Principles and Processes of Isolation of Eleme",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Limitations of Ellingham Diagram"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Limitations of Ellingham Diagram"}</h1>
