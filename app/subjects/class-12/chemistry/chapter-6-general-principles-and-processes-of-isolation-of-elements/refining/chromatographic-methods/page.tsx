...
export const metadata = {
  title: "Chromatographic Methods | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Chromatographic Methods - Refining, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illus",
  openGraph: {
    title: "Chromatographic Methods | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Chromatographic Methods - Refining, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illus",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-6-general-principles-and-processes-of-isolation-of-elements/refining" className="text-neutral-400 hover:text-white transition">{"Refining"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Chromatographic Methods"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Chromatographic Methods"}</h1>
