...
export const metadata = {
  title: "Vapour Phase Refining | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Vapour Phase Refining - Refining, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illustr",
  openGraph: {
    title: "Vapour Phase Refining | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Vapour Phase Refining - Refining, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illustr",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Vapour Phase Refining"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Vapour Phase Refining"}</h1>
