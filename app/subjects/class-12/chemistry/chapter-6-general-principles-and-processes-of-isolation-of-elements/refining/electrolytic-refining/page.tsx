...
export const metadata = {
  title: "Electrolytic Refining | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Electrolytic Refining - Refining, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illustr",
  openGraph: {
    title: "Electrolytic Refining | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Electrolytic Refining - Refining, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illustr",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Electrolytic Refining"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Electrolytic Refining"}</h1>
