...
export const metadata = {
  title: "Liquation | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Liquation - Refining, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Liquation | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Liquation - Refining, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Liquation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Liquation"}</h1>
