...
export const metadata = {
  title: "Zone Refining | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
  description: "Zone Refining - Refining, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Zone Refining | Chapter 6: General Principles and Processes of Isolation of Elements | Class 12 Chemistry",
    description: "Zone Refining - Refining, Chapter 6: General Principles and Processes of Isolation of Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Zone Refining"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Zone Refining"}</h1>
