...
export const metadata = {
  title: "Hydroboration-Oxidation | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Hydroboration-Oxidation - Preparation of Alcohols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Hydroboration-Oxidation | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Hydroboration-Oxidation - Preparation of Alcohols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Hydroboration-Oxidation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Hydroboration-Oxidation"}</h1>
