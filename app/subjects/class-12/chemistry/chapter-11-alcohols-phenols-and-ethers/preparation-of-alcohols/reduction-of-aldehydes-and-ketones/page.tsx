...
export const metadata = {
  title: "Reduction of Aldehydes and Ketones | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Reduction of Aldehydes and Ketones - Preparation of Alcohols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustr",
  openGraph: {
    title: "Reduction of Aldehydes and Ketones | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Reduction of Aldehydes and Ketones - Preparation of Alcohols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustr",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reduction of Aldehydes and Ketones"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reduction of Aldehydes and Ketones"}</h1>
