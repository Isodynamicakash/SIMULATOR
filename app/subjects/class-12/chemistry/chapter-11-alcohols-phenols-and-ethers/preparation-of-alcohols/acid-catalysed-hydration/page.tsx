...
export const metadata = {
  title: "Acid-Catalysed Hydration | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Acid-Catalysed Hydration - Preparation of Alcohols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Acid-Catalysed Hydration | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Acid-Catalysed Hydration - Preparation of Alcohols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Acid-Catalysed Hydration"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Acid-Catalysed Hydration"}</h1>
