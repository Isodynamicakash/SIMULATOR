...
export const metadata = {
  title: "Reduction of Carboxylic Acids and Esters | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Reduction of Carboxylic Acids and Esters - Preparation of Alcohols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and i",
  openGraph: {
    title: "Reduction of Carboxylic Acids and Esters | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Reduction of Carboxylic Acids and Esters - Preparation of Alcohols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and i",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-11-alcohols-phenols-and-ethers/preparation-of-alcohols" className="text-neutral-400 hover:text-white transition">{"Preparation of Alcohols"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reduction of Carboxylic Acids and Esters"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reduction of Carboxylic Acids and Esters"}</h1>
