...
export const metadata = {
  title: "From Cumene | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "From Cumene - Preparation of Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "From Cumene | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "From Cumene - Preparation of Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"From Cumene"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"From Cumene"}</h1>
