...
export const metadata = {
  title: "From Benzene Sulphonic Acid | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "From Benzene Sulphonic Acid - Preparation of Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "From Benzene Sulphonic Acid | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "From Benzene Sulphonic Acid - Preparation of Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-11-alcohols-phenols-and-ethers/preparation-of-phenols" className="text-neutral-400 hover:text-white transition">{"Preparation of Phenols"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"From Benzene Sulphonic Acid"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"From Benzene Sulphonic Acid"}</h1>
