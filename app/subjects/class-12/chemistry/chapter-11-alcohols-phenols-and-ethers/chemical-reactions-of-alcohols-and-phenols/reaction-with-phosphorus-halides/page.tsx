...
export const metadata = {
  title: "Reaction with Phosphorus Halides | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Reaction with Phosphorus Halides - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry ",
  openGraph: {
    title: "Reaction with Phosphorus Halides | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Reaction with Phosphorus Halides - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reaction with Phosphorus Halides"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reaction with Phosphorus Halides"}</h1>
