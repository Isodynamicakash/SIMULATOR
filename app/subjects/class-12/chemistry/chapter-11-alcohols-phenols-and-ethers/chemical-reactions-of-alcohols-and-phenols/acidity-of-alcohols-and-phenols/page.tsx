...
export const metadata = {
  title: "Acidity of Alcohols and Phenols | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Acidity of Alcohols and Phenols - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry n",
  openGraph: {
    title: "Acidity of Alcohols and Phenols | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Acidity of Alcohols and Phenols - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry n",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Acidity of Alcohols and Phenols"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Acidity of Alcohols and Phenols"}</h1>
