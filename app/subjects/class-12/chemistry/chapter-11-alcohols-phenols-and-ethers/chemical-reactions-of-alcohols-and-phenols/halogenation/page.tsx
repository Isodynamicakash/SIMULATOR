...
export const metadata = {
  title: "Halogenation | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Halogenation - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrati",
  openGraph: {
    title: "Halogenation | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Halogenation - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrati",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Halogenation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Halogenation"}</h1>
