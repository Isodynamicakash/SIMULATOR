...
export const metadata = {
  title: "Reimer-Tiemann Reaction | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Reimer-Tiemann Reaction - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and",
  openGraph: {
    title: "Reimer-Tiemann Reaction | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Reimer-Tiemann Reaction - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reimer-Tiemann Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reimer-Tiemann Reaction"}</h1>
