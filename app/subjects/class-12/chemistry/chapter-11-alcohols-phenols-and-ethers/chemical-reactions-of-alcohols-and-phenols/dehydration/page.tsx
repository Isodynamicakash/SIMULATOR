...
export const metadata = {
  title: "Dehydration | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Dehydration - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustratio",
  openGraph: {
    title: "Dehydration | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Dehydration - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustratio",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Dehydration"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Dehydration"}</h1>
