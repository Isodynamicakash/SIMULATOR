...
export const metadata = {
  title: "Coupling Reaction | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Coupling Reaction - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illus",
  openGraph: {
    title: "Coupling Reaction | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Coupling Reaction - Chemical Reactions of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illus",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Coupling Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Coupling Reaction"}</h1>
