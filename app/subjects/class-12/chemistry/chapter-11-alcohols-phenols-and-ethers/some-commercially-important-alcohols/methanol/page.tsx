...
export const metadata = {
  title: "Methanol | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Methanol - Some Commercially Important Alcohols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Methanol | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Methanol - Some Commercially Important Alcohols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-11-alcohols-phenols-and-ethers/some-commercially-important-alcohols" className="text-neutral-400 hover:text-white transition">{"Some Commercially Important Alcohols"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Methanol"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Methanol"}</h1>
