...
export const metadata = {
  title: "Structures of Functional Groups | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Structures of Functional Groups - Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry.",
  openGraph: {
    title: "Structures of Functional Groups | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Structures of Functional Groups - Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Structures of Functional Groups"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Structures of Functional Groups"}</h1>
