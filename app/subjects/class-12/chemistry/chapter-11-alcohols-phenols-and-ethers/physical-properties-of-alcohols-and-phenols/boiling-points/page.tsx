...
export const metadata = {
  title: "Boiling Points | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Boiling Points - Physical Properties of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustr",
  openGraph: {
    title: "Boiling Points | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Boiling Points - Physical Properties of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustr",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-11-alcohols-phenols-and-ethers/physical-properties-of-alcohols-and-phenols" className="text-neutral-400 hover:text-white transition">{"Physical Properties of Alcohols and Phenols"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Boiling Points"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Boiling Points"}</h1>
