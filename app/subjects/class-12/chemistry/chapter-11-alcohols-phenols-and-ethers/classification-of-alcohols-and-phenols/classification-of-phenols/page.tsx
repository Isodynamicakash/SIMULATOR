...
export const metadata = {
  title: "Classification of Phenols | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Classification of Phenols - Classification of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and i",
  openGraph: {
    title: "Classification of Phenols | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Classification of Phenols - Classification of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and i",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Classification of Phenols"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Classification of Phenols"}</h1>
