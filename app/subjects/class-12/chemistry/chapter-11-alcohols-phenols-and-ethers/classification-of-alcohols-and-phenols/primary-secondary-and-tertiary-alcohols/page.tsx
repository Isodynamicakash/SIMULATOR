...
export const metadata = {
  title: "Primary, Secondary, and Tertiary Alcohols | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Primary, Secondary, and Tertiary Alcohols - Classification of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemi",
  openGraph: {
    title: "Primary, Secondary, and Tertiary Alcohols | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Primary, Secondary, and Tertiary Alcohols - Classification of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemi",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-11-alcohols-phenols-and-ethers/classification-of-alcohols-and-phenols" className="text-neutral-400 hover:text-white transition">{"Classification of Alcohols and Phenols"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Primary, Secondary, and Tertiary Alcohols"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Primary, Secondary, and Tertiary Alcohols"}</h1>
