...
export const metadata = {
  title: "Classification of Alcohols | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Classification of Alcohols - Classification of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and ",
  openGraph: {
    title: "Classification of Alcohols | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Classification of Alcohols - Classification of Alcohols and Phenols, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Classification of Alcohols"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Classification of Alcohols"}</h1>
