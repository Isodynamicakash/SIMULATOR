...
export const metadata = {
  title: "Electrophilic Substitution (Aromatic Ethers) | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Electrophilic Substitution (Aromatic Ethers) - Chemical Reactions of Ethers, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry no",
  openGraph: {
    title: "Electrophilic Substitution (Aromatic Ethers) | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Electrophilic Substitution (Aromatic Ethers) - Chemical Reactions of Ethers, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry no",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Electrophilic Substitution (Aromatic Ethers)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Electrophilic Substitution (Aromatic Ethers)"}</h1>
