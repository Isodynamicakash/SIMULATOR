...
export const metadata = {
  title: "Cleavage of C—O Bond | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
  description: "Cleavage of C—O Bond - Chemical Reactions of Ethers, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Cleavage of C—O Bond | Chapter 11: Alcohols, Phenols and Ethers | Class 12 Chemistry",
    description: "Cleavage of C—O Bond - Chemical Reactions of Ethers, Chapter 11: Alcohols, Phenols and Ethers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Cleavage of C—O Bond"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Cleavage of C—O Bond"}</h1>
