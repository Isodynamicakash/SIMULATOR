...
export const metadata = {
  title: "Tranquilizers | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Tranquilizers - Therapeutic Action of Different Classes of Drugs, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illus",
  openGraph: {
    title: "Tranquilizers | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Tranquilizers - Therapeutic Action of Different Classes of Drugs, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illus",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Tranquilizers"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Tranquilizers"}</h1>
