...
export const metadata = {
  title: "Antiseptics | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Antiseptics - Therapeutic Action of Different Classes of Drugs, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustr",
  openGraph: {
    title: "Antiseptics | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Antiseptics - Therapeutic Action of Different Classes of Drugs, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustr",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Antiseptics"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Antiseptics"}</h1>
