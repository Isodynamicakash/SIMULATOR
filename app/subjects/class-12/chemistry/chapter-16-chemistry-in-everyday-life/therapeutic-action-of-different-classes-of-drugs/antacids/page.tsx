...
export const metadata = {
  title: "Antacids | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Antacids - Therapeutic Action of Different Classes of Drugs, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrati",
  openGraph: {
    title: "Antacids | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Antacids - Therapeutic Action of Different Classes of Drugs, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrati",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Antacids"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Antacids"}</h1>
