...
export const metadata = {
  title: "Aminoglycosides | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Aminoglycosides - Therapeutic Action of Different Classes of Drugs, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and ill",
  openGraph: {
    title: "Aminoglycosides | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Aminoglycosides - Therapeutic Action of Different Classes of Drugs, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and ill",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Aminoglycosides"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Aminoglycosides"}</h1>
