...
export const metadata = {
  title: "Analgesics | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Analgesics - Therapeutic Action of Different Classes of Drugs, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustra",
  openGraph: {
    title: "Analgesics | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Analgesics - Therapeutic Action of Different Classes of Drugs, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustra",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Analgesics"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Analgesics"}</h1>
