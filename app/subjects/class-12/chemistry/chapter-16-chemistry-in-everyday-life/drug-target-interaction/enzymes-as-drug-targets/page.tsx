...
export const metadata = {
  title: "Enzymes as Drug Targets | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Enzymes as Drug Targets - Drug-Target Interaction, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Enzymes as Drug Targets | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Enzymes as Drug Targets - Drug-Target Interaction, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Enzymes as Drug Targets"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Enzymes as Drug Targets"}</h1>
