...
export const metadata = {
  title: "Receptors as Drug Targets | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Receptors as Drug Targets - Drug-Target Interaction, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Receptors as Drug Targets | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Receptors as Drug Targets - Drug-Target Interaction, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-16-chemistry-in-everyday-life/drug-target-interaction" className="text-neutral-400 hover:text-white transition">{"Drug-Target Interaction"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Receptors as Drug Targets"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Receptors as Drug Targets"}</h1>
