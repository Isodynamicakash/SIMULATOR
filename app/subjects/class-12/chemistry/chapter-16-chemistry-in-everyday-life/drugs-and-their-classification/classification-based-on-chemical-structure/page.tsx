...
export const metadata = {
  title: "Classification Based on Chemical Structure | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Classification Based on Chemical Structure - Drugs and their Classification, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry note",
  openGraph: {
    title: "Classification Based on Chemical Structure | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Classification Based on Chemical Structure - Drugs and their Classification, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry note",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Classification Based on Chemical Structure"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Classification Based on Chemical Structure"}</h1>
