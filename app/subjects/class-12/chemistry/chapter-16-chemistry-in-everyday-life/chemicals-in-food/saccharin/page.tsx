...
export const metadata = {
  title: "Saccharin | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Saccharin - Chemicals in Food, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Saccharin | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Saccharin - Chemicals in Food, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Saccharin"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Saccharin"}</h1>
