...
export const metadata = {
  title: "Aspartame | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Aspartame - Chemicals in Food, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Aspartame | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Aspartame - Chemicals in Food, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Aspartame"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Aspartame"}</h1>
