...
export const metadata = {
  title: "Sugar | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Sugar - Chemicals in Food, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Sugar | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Sugar - Chemicals in Food, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Sugar"}</h1>
