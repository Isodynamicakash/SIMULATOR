...
export const metadata = {
  title: "Artificial Sweetening Agents | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Artificial Sweetening Agents - Chemicals in Food, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Artificial Sweetening Agents | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Artificial Sweetening Agents - Chemicals in Food, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-16-chemistry-in-everyday-life/chemicals-in-food" className="text-neutral-400 hover:text-white transition">{"Chemicals in Food"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Artificial Sweetening Agents"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Artificial Sweetening Agents"}</h1>
