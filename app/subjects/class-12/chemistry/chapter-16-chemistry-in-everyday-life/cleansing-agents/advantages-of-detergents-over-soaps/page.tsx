...
export const metadata = {
  title: "Advantages of Detergents over Soaps | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Advantages of Detergents over Soaps - Cleansing Agents, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Advantages of Detergents over Soaps | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Advantages of Detergents over Soaps - Cleansing Agents, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Advantages of Detergents over Soaps"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Advantages of Detergents over Soaps"}</h1>
