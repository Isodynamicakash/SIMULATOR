...
export const metadata = {
  title: "Cleansing Action of Soaps | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
  description: "Cleansing Action of Soaps - Cleansing Agents, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Cleansing Action of Soaps | Chapter 16: Chemistry in Everyday Life | Class 12 Chemistry",
    description: "Cleansing Action of Soaps - Cleansing Agents, Chapter 16: Chemistry in Everyday Life. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Cleansing Action of Soaps"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Cleansing Action of Soaps"}</h1>
