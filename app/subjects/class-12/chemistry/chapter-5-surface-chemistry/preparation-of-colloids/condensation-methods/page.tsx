...
export const metadata = {
  title: "Condensation Methods | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Condensation Methods - Preparation of Colloids, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Condensation Methods | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Condensation Methods - Preparation of Colloids, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-5-surface-chemistry/preparation-of-colloids" className="text-neutral-400 hover:text-white transition">{"Preparation of Colloids"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Condensation Methods"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Condensation Methods"}</h1>
