...
export const metadata = {
  title: "Dispersion Methods | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Dispersion Methods - Preparation of Colloids, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Dispersion Methods | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Dispersion Methods - Preparation of Colloids, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Dispersion Methods"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Dispersion Methods"}</h1>
