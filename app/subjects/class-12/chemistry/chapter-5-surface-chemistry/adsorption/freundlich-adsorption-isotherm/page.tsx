...
export const metadata = {
  title: "Freundlich Adsorption Isotherm | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Freundlich Adsorption Isotherm - Adsorption, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Freundlich Adsorption Isotherm | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Freundlich Adsorption Isotherm - Adsorption, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-5-surface-chemistry/adsorption" className="text-neutral-400 hover:text-white transition">{"Adsorption"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Freundlich Adsorption Isotherm"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Freundlich Adsorption Isotherm"}</h1>
