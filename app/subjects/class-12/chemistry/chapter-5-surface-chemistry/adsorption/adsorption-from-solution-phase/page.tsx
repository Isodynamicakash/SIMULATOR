...
export const metadata = {
  title: "Adsorption from Solution Phase | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Adsorption from Solution Phase - Adsorption, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Adsorption from Solution Phase | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Adsorption from Solution Phase - Adsorption, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Adsorption from Solution Phase"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Adsorption from Solution Phase"}</h1>
