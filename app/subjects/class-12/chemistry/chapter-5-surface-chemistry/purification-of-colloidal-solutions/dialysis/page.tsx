...
export const metadata = {
  title: "Dialysis | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Dialysis - Purification of Colloidal Solutions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Dialysis | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Dialysis - Purification of Colloidal Solutions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Dialysis"}</h1>
