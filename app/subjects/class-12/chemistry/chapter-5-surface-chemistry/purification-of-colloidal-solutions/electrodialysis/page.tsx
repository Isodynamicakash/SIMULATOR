...
export const metadata = {
  title: "Electrodialysis | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Electrodialysis - Purification of Colloidal Solutions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Electrodialysis | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Electrodialysis - Purification of Colloidal Solutions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-5-surface-chemistry/purification-of-colloidal-solutions" className="text-neutral-400 hover:text-white transition">{"Purification of Colloidal Solutions"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Electrodialysis"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Electrodialysis"}</h1>
