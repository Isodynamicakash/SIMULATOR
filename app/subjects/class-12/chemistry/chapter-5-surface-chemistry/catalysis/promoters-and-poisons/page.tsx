...
export const metadata = {
  title: "Promoters and Poisons | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Promoters and Poisons - Catalysis, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Promoters and Poisons | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Promoters and Poisons - Catalysis, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Promoters and Poisons"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Promoters and Poisons"}</h1>
