...
export const metadata = {
  title: "Enzyme Catalysis | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Enzyme Catalysis - Catalysis, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Enzyme Catalysis | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Enzyme Catalysis - Catalysis, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Enzyme Catalysis"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Enzyme Catalysis"}</h1>
