...
export const metadata = {
  title: "Adsorption Theory of Heterogeneous Catalysis | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Adsorption Theory of Heterogeneous Catalysis - Catalysis, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Adsorption Theory of Heterogeneous Catalysis | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Adsorption Theory of Heterogeneous Catalysis - Catalysis, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-5-surface-chemistry/catalysis" className="text-neutral-400 hover:text-white transition">{"Catalysis"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Adsorption Theory of Heterogeneous Catalysis"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Adsorption Theory of Heterogeneous Catalysis"}</h1>
