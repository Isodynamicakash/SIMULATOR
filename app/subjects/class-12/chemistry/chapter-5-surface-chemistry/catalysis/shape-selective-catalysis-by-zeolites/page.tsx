...
export const metadata = {
  title: "Shape Selective Catalysis by Zeolites | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Shape Selective Catalysis by Zeolites - Catalysis, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Shape Selective Catalysis by Zeolites | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Shape Selective Catalysis by Zeolites - Catalysis, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Shape Selective Catalysis by Zeolites"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Shape Selective Catalysis by Zeolites"}</h1>
