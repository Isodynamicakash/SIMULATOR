...
export const metadata = {
  title: "Coagulation or Flocculation | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Coagulation or Flocculation - Properties of Colloidal Solutions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Coagulation or Flocculation | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Coagulation or Flocculation - Properties of Colloidal Solutions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Coagulation or Flocculation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Coagulation or Flocculation"}</h1>
