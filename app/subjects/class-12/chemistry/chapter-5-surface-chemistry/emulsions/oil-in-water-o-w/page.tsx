...
export const metadata = {
  title: "Oil in Water (O/W) | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Oil in Water (O/W) - Emulsions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Oil in Water (O/W) | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Oil in Water (O/W) - Emulsions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Oil in Water (O/W)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Oil in Water (O/W)"}</h1>
