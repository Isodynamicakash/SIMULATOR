...
export const metadata = {
  title: "Types of Emulsions | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Types of Emulsions - Emulsions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Types of Emulsions | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Types of Emulsions - Emulsions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Types of Emulsions"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Types of Emulsions"}</h1>
