...
export const metadata = {
  title: "Preparation of Emulsions | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Preparation of Emulsions - Emulsions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Preparation of Emulsions | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Preparation of Emulsions - Emulsions, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-5-surface-chemistry/emulsions" className="text-neutral-400 hover:text-white transition">{"Emulsions"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Preparation of Emulsions"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Preparation of Emulsions"}</h1>
