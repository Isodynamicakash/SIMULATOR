...
export const metadata = {
  title: "Lyophilic Colloids | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Lyophilic Colloids - Colloids, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Lyophilic Colloids | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Lyophilic Colloids - Colloids, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Lyophilic Colloids"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Lyophilic Colloids"}</h1>
