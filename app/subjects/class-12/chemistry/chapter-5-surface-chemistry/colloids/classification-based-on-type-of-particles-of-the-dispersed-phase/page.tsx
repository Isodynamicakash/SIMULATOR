...
export const metadata = {
  title: "Classification Based on Type of Particles of the D | Chapter 5: Surface Chemistry | Class 12 Chemistry",
  description: "Classification Based on Type of Particles of the Dispersed Phase - Colloids, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illu",
  openGraph: {
    title: "Classification Based on Type of Particles of the D | Chapter 5: Surface Chemistry | Class 12 Chemistry",
    description: "Classification Based on Type of Particles of the Dispersed Phase - Colloids, Chapter 5: Surface Chemistry. Class 12 Chemistry notes and illu",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Classification Based on Type of Particles of the Dispersed Phase"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Classification Based on Type of Particles of the Dispersed Phase"}</h1>
