...
export const metadata = {
  title: "Products of Electrolysis | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Products of Electrolysis - Electrolytic Cells and Electrolysis, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Products of Electrolysis | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Products of Electrolysis - Electrolytic Cells and Electrolysis, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-3-electrochemistry/electrolytic-cells-and-electrolysis" className="text-neutral-400 hover:text-white transition">{"Electrolytic Cells and Electrolysis"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Products of Electrolysis"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Products of Electrolysis"}</h1>
