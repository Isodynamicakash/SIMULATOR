...
export const metadata = {
  title: "Electrolysis | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Electrolysis - Electrolytic Cells and Electrolysis, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Electrolysis | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Electrolysis - Electrolytic Cells and Electrolysis, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Electrolysis"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Electrolysis"}</h1>
