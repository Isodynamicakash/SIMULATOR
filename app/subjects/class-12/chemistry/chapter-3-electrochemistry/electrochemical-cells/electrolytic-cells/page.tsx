...
export const metadata = {
  title: "Electrolytic Cells | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Electrolytic Cells - Electrochemical Cells, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Electrolytic Cells | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Electrolytic Cells - Electrochemical Cells, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-3-electrochemistry/electrochemical-cells" className="text-neutral-400 hover:text-white transition">{"Electrochemical Cells"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Electrolytic Cells"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Electrolytic Cells"}</h1>
