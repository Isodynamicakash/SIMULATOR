...
export const metadata = {
  title: "Daniell Cell | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Daniell Cell - Galvanic Cells, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Daniell Cell | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Daniell Cell - Galvanic Cells, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Daniell Cell"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Daniell Cell"}</h1>
