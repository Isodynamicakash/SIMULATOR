...
export const metadata = {
  title: "Representation of a Galvanic Cell | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Representation of a Galvanic Cell - Galvanic Cells, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Representation of a Galvanic Cell | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Representation of a Galvanic Cell - Galvanic Cells, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-3-electrochemistry/galvanic-cells" className="text-neutral-400 hover:text-white transition">{"Galvanic Cells"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Representation of a Galvanic Cell"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Representation of a Galvanic Cell"}</h1>
