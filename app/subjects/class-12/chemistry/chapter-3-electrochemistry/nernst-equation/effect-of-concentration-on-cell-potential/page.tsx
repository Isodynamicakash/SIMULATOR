...
export const metadata = {
  title: "Effect of Concentration on Cell Potential | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Effect of Concentration on Cell Potential - Nernst Equation, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Effect of Concentration on Cell Potential | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Effect of Concentration on Cell Potential - Nernst Equation, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Effect of Concentration on Cell Potential"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Effect of Concentration on Cell Potential"}</h1>
