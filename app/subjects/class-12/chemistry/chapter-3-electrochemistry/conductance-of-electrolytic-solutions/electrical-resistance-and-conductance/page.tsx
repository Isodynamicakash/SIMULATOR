...
export const metadata = {
  title: "Electrical Resistance and Conductance | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Electrical Resistance and Conductance - Conductance of Electrolytic Solutions, Chapter 3: Electrochemistry. Class 12 Chemistry notes and ill",
  openGraph: {
    title: "Electrical Resistance and Conductance | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Electrical Resistance and Conductance - Conductance of Electrolytic Solutions, Chapter 3: Electrochemistry. Class 12 Chemistry notes and ill",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Electrical Resistance and Conductance"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Electrical Resistance and Conductance"}</h1>
