...
export const metadata = {
  title: "Conductivity and Molar Conductivity | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Conductivity and Molar Conductivity - Conductance of Electrolytic Solutions, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illus",
  openGraph: {
    title: "Conductivity and Molar Conductivity | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Conductivity and Molar Conductivity - Conductance of Electrolytic Solutions, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illus",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Conductivity and Molar Conductivity"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Conductivity and Molar Conductivity"}</h1>
