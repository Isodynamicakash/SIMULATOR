...
export const metadata = {
  title: "Hydrogen-Oxygen Fuel Cell | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Hydrogen-Oxygen Fuel Cell - Batteries, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Hydrogen-Oxygen Fuel Cell | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Hydrogen-Oxygen Fuel Cell - Batteries, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-3-electrochemistry/batteries" className="text-neutral-400 hover:text-white transition">{"Batteries"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Hydrogen-Oxygen Fuel Cell"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Hydrogen-Oxygen Fuel Cell"}</h1>
