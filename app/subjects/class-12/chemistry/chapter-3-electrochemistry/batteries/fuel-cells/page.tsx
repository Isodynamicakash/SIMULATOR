...
export const metadata = {
  title: "Fuel Cells | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Fuel Cells - Batteries, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Fuel Cells | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Fuel Cells - Batteries, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Fuel Cells"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Fuel Cells"}</h1>
