...
export const metadata = {
  title: "Electrochemical Theory of Corrosion | Chapter 3: Electrochemistry | Class 12 Chemistry",
  description: "Electrochemical Theory of Corrosion - Corrosion, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Electrochemical Theory of Corrosion | Chapter 3: Electrochemistry | Class 12 Chemistry",
    description: "Electrochemical Theory of Corrosion - Corrosion, Chapter 3: Electrochemistry. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-3-electrochemistry/corrosion" className="text-neutral-400 hover:text-white transition">{"Corrosion"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Electrochemical Theory of Corrosion"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Electrochemical Theory of Corrosion"}</h1>
