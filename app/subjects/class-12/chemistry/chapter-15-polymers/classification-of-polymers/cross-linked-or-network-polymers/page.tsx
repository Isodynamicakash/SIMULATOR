...
export const metadata = {
  title: "Cross-linked or Network Polymers | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Cross-linked or Network Polymers - Classification of Polymers, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Cross-linked or Network Polymers | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Cross-linked or Network Polymers - Classification of Polymers, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Cross-linked or Network Polymers"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Cross-linked or Network Polymers"}</h1>
