...
export const metadata = {
  title: "Classification Based on Structure | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Classification Based on Structure - Classification of Polymers, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Classification Based on Structure | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Classification Based on Structure - Classification of Polymers, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Classification Based on Structure"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Classification Based on Structure"}</h1>
