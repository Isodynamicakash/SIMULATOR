...
export const metadata = {
  title: "Classification Based on Mode of Polymerisation | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Classification Based on Mode of Polymerisation - Classification of Polymers, Chapter 15: Polymers. Class 12 Chemistry notes and illustration",
  openGraph: {
    title: "Classification Based on Mode of Polymerisation | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Classification Based on Mode of Polymerisation - Classification of Polymers, Chapter 15: Polymers. Class 12 Chemistry notes and illustration",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-15-polymers/classification-of-polymers" className="text-neutral-400 hover:text-white transition">{"Classification of Polymers"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Classification Based on Mode of Polymerisation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Classification Based on Mode of Polymerisation"}</h1>
