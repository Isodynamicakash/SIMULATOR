...
export const metadata = {
  title: "Weight Average Molecular Mass | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Weight Average Molecular Mass - Molecular Mass of Polymers, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Weight Average Molecular Mass | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Weight Average Molecular Mass - Molecular Mass of Polymers, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Weight Average Molecular Mass"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Weight Average Molecular Mass"}</h1>
