...
export const metadata = {
  title: "Number Average Molecular Mass | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Number Average Molecular Mass - Molecular Mass of Polymers, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Number Average Molecular Mass | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Number Average Molecular Mass - Molecular Mass of Polymers, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-15-polymers/molecular-mass-of-polymers" className="text-neutral-400 hover:text-white transition">{"Molecular Mass of Polymers"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Number Average Molecular Mass"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Number Average Molecular Mass"}</h1>
