...
export const metadata = {
  title: "Polyvinyl Chloride (PVC) | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Polyvinyl Chloride (PVC) - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Polyvinyl Chloride (PVC) | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Polyvinyl Chloride (PVC) - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Polyvinyl Chloride (PVC)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Polyvinyl Chloride (PVC)"}</h1>
