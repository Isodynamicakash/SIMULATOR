...
export const metadata = {
  title: "Polythene | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Polythene - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Polythene | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Polythene - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Polythene"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Polythene"}</h1>
