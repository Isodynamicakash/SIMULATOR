...
export const metadata = {
  title: "Melamine-Formaldehyde Polymer | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Melamine-Formaldehyde Polymer - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Melamine-Formaldehyde Polymer | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Melamine-Formaldehyde Polymer - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Melamine-Formaldehyde Polymer"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Melamine-Formaldehyde Polymer"}</h1>
