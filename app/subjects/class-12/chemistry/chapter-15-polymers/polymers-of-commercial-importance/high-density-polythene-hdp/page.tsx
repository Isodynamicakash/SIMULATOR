...
export const metadata = {
  title: "High Density Polythene (HDP) | Chapter 15: Polymers | Class 12 Chemistry",
  description: "High Density Polythene (HDP) - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "High Density Polythene (HDP) | Chapter 15: Polymers | Class 12 Chemistry",
    description: "High Density Polythene (HDP) - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"High Density Polythene (HDP)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"High Density Polythene (HDP)"}</h1>
