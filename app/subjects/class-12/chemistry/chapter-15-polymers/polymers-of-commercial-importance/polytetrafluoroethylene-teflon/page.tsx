...
export const metadata = {
  title: "Polytetrafluoroethylene (Teflon) | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Polytetrafluoroethylene (Teflon) - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Polytetrafluoroethylene (Teflon) | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Polytetrafluoroethylene (Teflon) - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-15-polymers/polymers-of-commercial-importance" className="text-neutral-400 hover:text-white transition">{"Polymers of Commercial Importance"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Polytetrafluoroethylene (Teflon)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Polytetrafluoroethylene (Teflon)"}</h1>
