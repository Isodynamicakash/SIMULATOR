...
export const metadata = {
  title: "Poly(methyl methacrylate) (PMMA) | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Poly(methyl methacrylate) (PMMA) - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Poly(methyl methacrylate) (PMMA) | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Poly(methyl methacrylate) (PMMA) - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Poly(methyl methacrylate) (PMMA)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Poly(methyl methacrylate) (PMMA)"}</h1>
