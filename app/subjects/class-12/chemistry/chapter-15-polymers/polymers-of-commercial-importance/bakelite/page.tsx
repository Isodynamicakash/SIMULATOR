...
export const metadata = {
  title: "Bakelite | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Bakelite - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Bakelite | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Bakelite - Polymers of Commercial Importance, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Bakelite"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Bakelite"}</h1>
