...
export const metadata = {
  title: "Free Radical Mechanism | Chapter 15: Polymers | Class 12 Chemistry",
  description: "Free Radical Mechanism - Types of Polymerisation Reactions, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Free Radical Mechanism | Chapter 15: Polymers | Class 12 Chemistry",
    description: "Free Radical Mechanism - Types of Polymerisation Reactions, Chapter 15: Polymers. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Free Radical Mechanism"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Free Radical Mechanism"}</h1>
