...
export const metadata = {
  title: "Ligands | Chapter 9: Coordination Compounds | Class 12 Chemistry",
  description: "Ligands - Definitions of Some Important Terms Pertaining to Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry no",
  openGraph: {
    title: "Ligands | Chapter 9: Coordination Compounds | Class 12 Chemistry",
    description: "Ligands - Definitions of Some Important Terms Pertaining to Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry no",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Ligands"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Ligands"}</h1>
