...
export const metadata = {
  title: "Central Atom/Ion | Chapter 9: Coordination Compounds | Class 12 Chemistry",
  description: "Central Atom/Ion - Definitions of Some Important Terms Pertaining to Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Che",
  openGraph: {
    title: "Central Atom/Ion | Chapter 9: Coordination Compounds | Class 12 Chemistry",
    description: "Central Atom/Ion - Definitions of Some Important Terms Pertaining to Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Che",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Central Atom/Ion"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Central Atom/Ion"}</h1>
