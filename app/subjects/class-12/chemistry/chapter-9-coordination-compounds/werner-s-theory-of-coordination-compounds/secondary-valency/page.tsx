...
export const metadata = {
  title: "Secondary Valency | Chapter 9: Coordination Compounds | Class 12 Chemistry",
  description: "Secondary Valency - Werner's Theory of Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and illustrations",
  openGraph: {
    title: "Secondary Valency | Chapter 9: Coordination Compounds | Class 12 Chemistry",
    description: "Secondary Valency - Werner's Theory of Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and illustrations",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-9-coordination-compounds/werner-s-theory-of-coordination-compounds" className="text-neutral-400 hover:text-white transition">{"Werner's Theory of Coordination Compounds"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Secondary Valency"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Secondary Valency"}</h1>
