...
export const metadata = {
  title: "Importance and Applications of Coordination Compou | Chapter 9: Coordination Compounds | Class 12 Chemistry",
  description: "Importance and Applications of Coordination Compounds - Chapter 9: Coordination Compounds. Class 12 Chemistry.",
  openGraph: {
    title: "Importance and Applications of Coordination Compou | Chapter 9: Coordination Compounds | Class 12 Chemistry",
    description: "Importance and Applications of Coordination Compounds - Chapter 9: Coordination Compounds. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Importance and Applications of Coordination Compounds"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Importance and Applications of Coordination Compounds"}</h1>
