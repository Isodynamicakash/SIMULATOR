...
export const metadata = {
  title: "Colour in Coordination Compounds | Chapter 9: Coordination Compounds | Class 12 Chemistry",
  description: "Colour in Coordination Compounds - Bonding in Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and illust",
  openGraph: {
    title: "Colour in Coordination Compounds | Chapter 9: Coordination Compounds | Class 12 Chemistry",
    description: "Colour in Coordination Compounds - Bonding in Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and illust",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Colour in Coordination Compounds"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Colour in Coordination Compounds"}</h1>
