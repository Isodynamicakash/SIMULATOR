...
export const metadata = {
  title: "Limitations of Crystal Field Theory | Chapter 9: Coordination Compounds | Class 12 Chemistry",
  description: "Limitations of Crystal Field Theory - Bonding in Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and ill",
  openGraph: {
    title: "Limitations of Crystal Field Theory | Chapter 9: Coordination Compounds | Class 12 Chemistry",
    description: "Limitations of Crystal Field Theory - Bonding in Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and ill",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Limitations of Crystal Field Theory"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Limitations of Crystal Field Theory"}</h1>
