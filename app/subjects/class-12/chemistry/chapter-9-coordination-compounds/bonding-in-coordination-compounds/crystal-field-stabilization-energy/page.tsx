...
export const metadata = {
  title: "Crystal Field Stabilization Energy | Chapter 9: Coordination Compounds | Class 12 Chemistry",
  description: "Crystal Field Stabilization Energy - Bonding in Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and illu",
  openGraph: {
    title: "Crystal Field Stabilization Energy | Chapter 9: Coordination Compounds | Class 12 Chemistry",
    description: "Crystal Field Stabilization Energy - Bonding in Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and illu",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Crystal Field Stabilization Energy"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Crystal Field Stabilization Energy"}</h1>
