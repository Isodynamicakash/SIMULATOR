...
export const metadata = {
  title: "Inner Orbital Complexes | Chapter 9: Coordination Compounds | Class 12 Chemistry",
  description: "Inner Orbital Complexes - Bonding in Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Inner Orbital Complexes | Chapter 9: Coordination Compounds | Class 12 Chemistry",
    description: "Inner Orbital Complexes - Bonding in Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Inner Orbital Complexes"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Inner Orbital Complexes"}</h1>
