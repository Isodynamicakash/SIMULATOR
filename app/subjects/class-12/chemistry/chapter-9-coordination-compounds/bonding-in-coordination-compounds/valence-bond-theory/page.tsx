...
export const metadata = {
  title: "Valence Bond Theory | Chapter 9: Coordination Compounds | Class 12 Chemistry",
  description: "Valence Bond Theory - Bonding in Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Valence Bond Theory | Chapter 9: Coordination Compounds | Class 12 Chemistry",
    description: "Valence Bond Theory - Bonding in Coordination Compounds, Chapter 9: Coordination Compounds. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Valence Bond Theory"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Valence Bond Theory"}</h1>
