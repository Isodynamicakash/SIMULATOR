...
export const metadata = {
  title: "Reaction with Metals | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Reaction with Metals - Chemical Reactions of Haloalkanes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrations",
  openGraph: {
    title: "Reaction with Metals | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Reaction with Metals - Chemical Reactions of Haloalkanes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrations",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reaction with Metals"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reaction with Metals"}</h1>
