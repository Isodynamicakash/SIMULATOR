...
export const metadata = {
  title: "Optical Activity | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Optical Activity - Chemical Reactions of Haloalkanes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Optical Activity | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Optical Activity - Chemical Reactions of Haloalkanes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Optical Activity"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Optical Activity"}</h1>
