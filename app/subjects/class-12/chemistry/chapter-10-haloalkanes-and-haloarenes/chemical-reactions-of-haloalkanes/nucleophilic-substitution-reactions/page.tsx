...
export const metadata = {
  title: "Nucleophilic Substitution Reactions | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Nucleophilic Substitution Reactions - Chemical Reactions of Haloalkanes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes an",
  openGraph: {
    title: "Nucleophilic Substitution Reactions | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Nucleophilic Substitution Reactions - Chemical Reactions of Haloalkanes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes an",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-10-haloalkanes-and-haloarenes/chemical-reactions-of-haloalkanes" className="text-neutral-400 hover:text-white transition">{"Chemical Reactions of Haloalkanes"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Nucleophilic Substitution Reactions"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Nucleophilic Substitution Reactions"}</h1>
