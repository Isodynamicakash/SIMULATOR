...
export const metadata = {
  title: "On the Basis of Number of Halogen Atoms | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "On the Basis of Number of Halogen Atoms - Classification of Halogen Derivatives, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry ",
  openGraph: {
    title: "On the Basis of Number of Halogen Atoms | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "On the Basis of Number of Halogen Atoms - Classification of Halogen Derivatives, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"On the Basis of Number of Halogen Atoms"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"On the Basis of Number of Halogen Atoms"}</h1>
