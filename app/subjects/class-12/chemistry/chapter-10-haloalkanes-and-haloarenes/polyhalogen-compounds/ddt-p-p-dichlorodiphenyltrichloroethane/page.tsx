...
export const metadata = {
  title: "DDT (p,p'-Dichlorodiphenyltrichloroethane) | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "DDT (p,p'-Dichlorodiphenyltrichloroethane) - Polyhalogen Compounds, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and ill",
  openGraph: {
    title: "DDT (p,p'-Dichlorodiphenyltrichloroethane) | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "DDT (p,p'-Dichlorodiphenyltrichloroethane) - Polyhalogen Compounds, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and ill",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"DDT (p,p'-Dichlorodiphenyltrichloroethane)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"DDT (p,p'-Dichlorodiphenyltrichloroethane)"}</h1>
