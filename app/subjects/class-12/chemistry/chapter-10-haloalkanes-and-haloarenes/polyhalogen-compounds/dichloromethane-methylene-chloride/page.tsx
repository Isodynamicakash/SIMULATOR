...
export const metadata = {
  title: "Dichloromethane (Methylene Chloride) | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Dichloromethane (Methylene Chloride) - Polyhalogen Compounds, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrat",
  openGraph: {
    title: "Dichloromethane (Methylene Chloride) | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Dichloromethane (Methylene Chloride) - Polyhalogen Compounds, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrat",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Dichloromethane (Methylene Chloride)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Dichloromethane (Methylene Chloride)"}</h1>
