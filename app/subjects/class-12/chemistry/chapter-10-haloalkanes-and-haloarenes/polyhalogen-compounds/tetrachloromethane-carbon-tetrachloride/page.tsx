...
export const metadata = {
  title: "Tetrachloromethane (Carbon Tetrachloride) | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Tetrachloromethane (Carbon Tetrachloride) - Polyhalogen Compounds, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illu",
  openGraph: {
    title: "Tetrachloromethane (Carbon Tetrachloride) | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Tetrachloromethane (Carbon Tetrachloride) - Polyhalogen Compounds, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illu",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-10-haloalkanes-and-haloarenes/polyhalogen-compounds" className="text-neutral-400 hover:text-white transition">{"Polyhalogen Compounds"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Tetrachloromethane (Carbon Tetrachloride)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Tetrachloromethane (Carbon Tetrachloride)"}</h1>
