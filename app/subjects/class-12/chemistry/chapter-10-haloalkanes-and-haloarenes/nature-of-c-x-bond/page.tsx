...
export const metadata = {
  title: "Nature of C—X Bond | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Nature of C—X Bond - Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry.",
  openGraph: {
    title: "Nature of C—X Bond | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Nature of C—X Bond - Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Nature of C—X Bond"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Nature of C—X Bond"}</h1>
