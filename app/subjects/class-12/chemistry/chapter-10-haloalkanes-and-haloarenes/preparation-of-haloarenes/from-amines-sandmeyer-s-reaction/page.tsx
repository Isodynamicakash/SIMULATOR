...
export const metadata = {
  title: "From Amines (Sandmeyer's Reaction) | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "From Amines (Sandmeyer's Reaction) - Preparation of Haloarenes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustr",
  openGraph: {
    title: "From Amines (Sandmeyer's Reaction) | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "From Amines (Sandmeyer's Reaction) - Preparation of Haloarenes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustr",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-10-haloalkanes-and-haloarenes/preparation-of-haloarenes" className="text-neutral-400 hover:text-white transition">{"Preparation of Haloarenes"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"From Amines (Sandmeyer's Reaction)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"From Amines (Sandmeyer's Reaction)"}</h1>
