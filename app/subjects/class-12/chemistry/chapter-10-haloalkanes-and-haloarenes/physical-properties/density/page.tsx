...
export const metadata = {
  title: "Density | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Density - Physical Properties, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Density | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Density - Physical Properties, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Density"}</h1>
