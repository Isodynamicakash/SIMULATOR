...
export const metadata = {
  title: "Boiling Points | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Boiling Points - Physical Properties, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Boiling Points | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Boiling Points - Physical Properties, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-10-haloalkanes-and-haloarenes/physical-properties" className="text-neutral-400 hover:text-white transition">{"Physical Properties"}</Link>
        <span className="text-neutral-600">/</span>
