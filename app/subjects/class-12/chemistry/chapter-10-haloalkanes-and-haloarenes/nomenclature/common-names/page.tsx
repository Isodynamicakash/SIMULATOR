...
export const metadata = {
  title: "Common Names | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Common Names - Nomenclature, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Common Names | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Common Names - Nomenclature, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-10-haloalkanes-and-haloarenes/nomenclature" className="text-neutral-400 hover:text-white transition">{"Nomenclature"}</Link>
        <span className="text-neutral-600">/</span>
