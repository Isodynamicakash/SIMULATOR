...
export const metadata = {
  title: "Addition of Hydrogen Halides to Alkenes | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Addition of Hydrogen Halides to Alkenes - Methods of Preparation of Haloalkanes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry ",
  openGraph: {
    title: "Addition of Hydrogen Halides to Alkenes | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Addition of Hydrogen Halides to Alkenes - Methods of Preparation of Haloalkanes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Addition of Hydrogen Halides to Alkenes"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Addition of Hydrogen Halides to Alkenes"}</h1>
