...
export const metadata = {
  title: "From Other Halogen Compounds | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "From Other Halogen Compounds - Methods of Preparation of Haloalkanes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and i",
  openGraph: {
    title: "From Other Halogen Compounds | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "From Other Halogen Compounds - Methods of Preparation of Haloalkanes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and i",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"From Other Halogen Compounds"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"From Other Halogen Compounds"}</h1>
