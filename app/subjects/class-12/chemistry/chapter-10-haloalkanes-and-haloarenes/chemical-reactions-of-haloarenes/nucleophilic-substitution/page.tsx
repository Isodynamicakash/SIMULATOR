...
export const metadata = {
  title: "Nucleophilic Substitution | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Nucleophilic Substitution - Chemical Reactions of Haloarenes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrat",
  openGraph: {
    title: "Nucleophilic Substitution | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Nucleophilic Substitution - Chemical Reactions of Haloarenes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrat",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Nucleophilic Substitution"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Nucleophilic Substitution"}</h1>
