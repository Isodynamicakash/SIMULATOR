...
export const metadata = {
  title: "Friedel-Crafts Acylation | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Friedel-Crafts Acylation - Chemical Reactions of Haloarenes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrati",
  openGraph: {
    title: "Friedel-Crafts Acylation | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Friedel-Crafts Acylation - Chemical Reactions of Haloarenes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustrati",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Friedel-Crafts Acylation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Friedel-Crafts Acylation"}</h1>
