...
export const metadata = {
  title: "Electrophilic Substitution | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
  description: "Electrophilic Substitution - Chemical Reactions of Haloarenes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustra",
  openGraph: {
    title: "Electrophilic Substitution | Chapter 10: Haloalkanes and Haloarenes | Class 12 Chemistry",
    description: "Electrophilic Substitution - Chemical Reactions of Haloarenes, Chapter 10: Haloalkanes and Haloarenes. Class 12 Chemistry notes and illustra",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-10-haloalkanes-and-haloarenes/chemical-reactions-of-haloarenes" className="text-neutral-400 hover:text-white transition">{"Chemical Reactions of Haloarenes"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Electrophilic Substitution"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Electrophilic Substitution"}</h1>
