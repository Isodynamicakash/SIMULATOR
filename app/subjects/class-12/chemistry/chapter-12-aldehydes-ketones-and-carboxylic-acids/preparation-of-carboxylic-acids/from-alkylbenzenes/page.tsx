...
export const metadata = {
  title: "From Alkylbenzenes | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "From Alkylbenzenes - Preparation of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and illu",
  openGraph: {
    title: "From Alkylbenzenes | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "From Alkylbenzenes - Preparation of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and illu",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"From Alkylbenzenes"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"From Alkylbenzenes"}</h1>
