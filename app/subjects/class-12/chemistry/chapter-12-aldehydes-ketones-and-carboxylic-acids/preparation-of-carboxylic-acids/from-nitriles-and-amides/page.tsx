...
export const metadata = {
  title: "From Nitriles and Amides | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "From Nitriles and Amides - Preparation of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes an",
  openGraph: {
    title: "From Nitriles and Amides | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "From Nitriles and Amides - Preparation of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes an",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"From Nitriles and Amides"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"From Nitriles and Amides"}</h1>
