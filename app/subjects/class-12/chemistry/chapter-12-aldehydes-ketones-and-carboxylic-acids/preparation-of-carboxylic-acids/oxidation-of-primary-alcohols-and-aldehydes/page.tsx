...
export const metadata = {
  title: "Oxidation of Primary Alcohols and Aldehydes | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Oxidation of Primary Alcohols and Aldehydes - Preparation of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12",
  openGraph: {
    title: "Oxidation of Primary Alcohols and Aldehydes | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Oxidation of Primary Alcohols and Aldehydes - Preparation of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-12-aldehydes-ketones-and-carboxylic-acids/preparation-of-carboxylic-acids" className="text-neutral-400 hover:text-white transition">{"Preparation of Carboxylic Acids"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Oxidation of Primary Alcohols and Aldehydes"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Oxidation of Primary Alcohols and Aldehydes"}</h1>
