...
export const metadata = {
  title: "Hydrolysis of Esters | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Hydrolysis of Esters - Preparation of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and il",
  openGraph: {
    title: "Hydrolysis of Esters | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Hydrolysis of Esters - Preparation of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and il",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Hydrolysis of Esters"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Hydrolysis of Esters"}</h1>
