...
export const metadata = {
  title: "Acidic Hydrolysis of Nitriles | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Acidic Hydrolysis of Nitriles - Preparation of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry not",
  openGraph: {
    title: "Acidic Hydrolysis of Nitriles | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Acidic Hydrolysis of Nitriles - Preparation of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry not",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Acidic Hydrolysis of Nitriles"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Acidic Hydrolysis of Nitriles"}</h1>
