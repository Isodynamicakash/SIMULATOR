...
export const metadata = {
  title: "Common Names | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Common Names - Nomenclature and Structure of Carbonyl Group, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes a",
  openGraph: {
    title: "Common Names | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Common Names - Nomenclature and Structure of Carbonyl Group, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes a",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-12-aldehydes-ketones-and-carboxylic-acids/nomenclature-and-structure-of-carbonyl-group" className="text-neutral-400 hover:text-white transition">{"Nomenclature and Structure of Carbonyl Group"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Common Names"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Common Names"}</h1>
