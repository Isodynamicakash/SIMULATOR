...
export const metadata = {
  title: "Aldol Condensation | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Aldol Condensation - Chemical Reactions of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry no",
  openGraph: {
    title: "Aldol Condensation | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Aldol Condensation - Chemical Reactions of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry no",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Aldol Condensation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Aldol Condensation"}</h1>
