...
export const metadata = {
  title: "Addition of Grignard Reagents | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Addition of Grignard Reagents - Chemical Reactions of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 C",
  openGraph: {
    title: "Addition of Grignard Reagents | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Addition of Grignard Reagents - Chemical Reactions of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 C",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Addition of Grignard Reagents"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Addition of Grignard Reagents"}</h1>
