...
export const metadata = {
  title: "Reactions due to α-Hydrogen | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Reactions due to α-Hydrogen - Chemical Reactions of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Che",
  openGraph: {
    title: "Reactions due to α-Hydrogen | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Reactions due to α-Hydrogen - Chemical Reactions of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Che",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reactions due to α-Hydrogen"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reactions due to α-Hydrogen"}</h1>
