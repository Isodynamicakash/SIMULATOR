...
export const metadata = {
  title: "Electrophilic Substitution Reaction (in Aromatic A | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Electrophilic Substitution Reaction (in Aromatic Aldehydes) - Chemical Reactions of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones an",
  openGraph: {
    title: "Electrophilic Substitution Reaction (in Aromatic A | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Electrophilic Substitution Reaction (in Aromatic Aldehydes) - Chemical Reactions of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones an",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Electrophilic Substitution Reaction (in Aromatic Aldehydes)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Electrophilic Substitution Reaction (in Aromatic Aldehydes)"}</h1>
