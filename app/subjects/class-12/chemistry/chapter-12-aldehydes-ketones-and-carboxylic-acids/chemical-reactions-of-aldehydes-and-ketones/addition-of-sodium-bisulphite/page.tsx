...
export const metadata = {
  title: "Addition of Sodium Bisulphite | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Addition of Sodium Bisulphite - Chemical Reactions of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 C",
  openGraph: {
    title: "Addition of Sodium Bisulphite | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Addition of Sodium Bisulphite - Chemical Reactions of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 C",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Addition of Sodium Bisulphite"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Addition of Sodium Bisulphite"}</h1>
