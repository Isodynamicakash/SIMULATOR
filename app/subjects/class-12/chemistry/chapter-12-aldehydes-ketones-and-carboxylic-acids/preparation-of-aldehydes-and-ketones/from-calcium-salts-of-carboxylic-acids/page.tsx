...
export const metadata = {
  title: "From Calcium Salts of Carboxylic Acids | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "From Calcium Salts of Carboxylic Acids - Preparation of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12",
  openGraph: {
    title: "From Calcium Salts of Carboxylic Acids | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "From Calcium Salts of Carboxylic Acids - Preparation of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"From Calcium Salts of Carboxylic Acids"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"From Calcium Salts of Carboxylic Acids"}</h1>
