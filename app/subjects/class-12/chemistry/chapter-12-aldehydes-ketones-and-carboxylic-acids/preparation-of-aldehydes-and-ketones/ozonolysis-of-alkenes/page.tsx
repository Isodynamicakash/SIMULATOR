...
export const metadata = {
  title: "Ozonolysis of Alkenes | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Ozonolysis of Alkenes - Preparation of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes ",
  openGraph: {
    title: "Ozonolysis of Alkenes | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Ozonolysis of Alkenes - Preparation of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Ozonolysis of Alkenes"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Ozonolysis of Alkenes"}</h1>
