...
export const metadata = {
  title: "Dehydrogenation of Alcohols | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Dehydrogenation of Alcohols - Preparation of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry ",
  openGraph: {
    title: "Dehydrogenation of Alcohols | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Dehydrogenation of Alcohols - Preparation of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Dehydrogenation of Alcohols"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Dehydrogenation of Alcohols"}</h1>
