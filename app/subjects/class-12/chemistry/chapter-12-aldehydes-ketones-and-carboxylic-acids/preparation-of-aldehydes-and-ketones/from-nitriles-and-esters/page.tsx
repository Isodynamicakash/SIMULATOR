...
export const metadata = {
  title: "From Nitriles and Esters | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "From Nitriles and Esters - Preparation of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry not",
  openGraph: {
    title: "From Nitriles and Esters | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "From Nitriles and Esters - Preparation of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry not",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"From Nitriles and Esters"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"From Nitriles and Esters"}</h1>
