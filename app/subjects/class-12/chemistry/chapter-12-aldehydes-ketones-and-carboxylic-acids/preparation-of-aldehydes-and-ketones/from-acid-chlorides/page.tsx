...
export const metadata = {
  title: "From Acid Chlorides | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "From Acid Chlorides - Preparation of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes an",
  openGraph: {
    title: "From Acid Chlorides | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "From Acid Chlorides - Preparation of Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes an",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"From Acid Chlorides"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"From Acid Chlorides"}</h1>
