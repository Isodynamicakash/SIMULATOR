...
export const metadata = {
  title: "Formation of Anhydride | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Formation of Anhydride - Chemical Reactions of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry not",
  openGraph: {
    title: "Formation of Anhydride | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Formation of Anhydride - Chemical Reactions of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry not",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Formation of Anhydride"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Formation of Anhydride"}</h1>
