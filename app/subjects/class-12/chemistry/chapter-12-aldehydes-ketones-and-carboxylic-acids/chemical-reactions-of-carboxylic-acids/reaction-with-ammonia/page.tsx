...
export const metadata = {
  title: "Reaction with Ammonia | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Reaction with Ammonia - Chemical Reactions of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry note",
  openGraph: {
    title: "Reaction with Ammonia | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Reaction with Ammonia - Chemical Reactions of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry note",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reaction with Ammonia"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reaction with Ammonia"}</h1>
