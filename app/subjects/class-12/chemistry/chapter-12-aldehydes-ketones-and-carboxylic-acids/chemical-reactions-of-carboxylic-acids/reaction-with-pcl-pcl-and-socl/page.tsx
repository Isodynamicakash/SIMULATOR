...
export const metadata = {
  title: "Reaction with PCl₃, PCl₅, and SOCl₂ | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Reaction with PCl₃, PCl₅, and SOCl₂ - Chemical Reactions of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 ",
  openGraph: {
    title: "Reaction with PCl₃, PCl₅, and SOCl₂ | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Reaction with PCl₃, PCl₅, and SOCl₂ - Chemical Reactions of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reaction with PCl₃, PCl₅, and SOCl₂"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reaction with PCl₃, PCl₅, and SOCl₂"}</h1>
