...
export const metadata = {
  title: "Hell-Volhard-Zelinsky Reaction | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Hell-Volhard-Zelinsky Reaction - Chemical Reactions of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemi",
  openGraph: {
    title: "Hell-Volhard-Zelinsky Reaction | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Hell-Volhard-Zelinsky Reaction - Chemical Reactions of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemi",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Hell-Volhard-Zelinsky Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Hell-Volhard-Zelinsky Reaction"}</h1>
