...
export const metadata = {
  title: "Decarboxylation | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Decarboxylation - Chemical Reactions of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and ",
  openGraph: {
    title: "Decarboxylation | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Decarboxylation - Chemical Reactions of Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and ",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Decarboxylation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Decarboxylation"}</h1>
