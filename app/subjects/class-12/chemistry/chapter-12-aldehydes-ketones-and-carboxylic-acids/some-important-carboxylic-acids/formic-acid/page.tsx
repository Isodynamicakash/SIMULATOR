...
export const metadata = {
  title: "Formic Acid | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Formic Acid - Some Important Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and illustratio",
  openGraph: {
    title: "Formic Acid | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Formic Acid - Some Important Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and illustratio",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Formic Acid"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Formic Acid"}</h1>
