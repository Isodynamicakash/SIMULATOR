...
export const metadata = {
  title: "Benzoic Acid | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Benzoic Acid - Some Important Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and illustrati",
  openGraph: {
    title: "Benzoic Acid | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Benzoic Acid - Some Important Carboxylic Acids, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and illustrati",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-12-aldehydes-ketones-and-carboxylic-acids/some-important-carboxylic-acids" className="text-neutral-400 hover:text-white transition">{"Some Important Carboxylic Acids"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Benzoic Acid"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Benzoic Acid"}</h1>
