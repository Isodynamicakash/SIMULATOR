...
export const metadata = {
  title: "Formaldehyde | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Formaldehyde - Some Important Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and illus",
  openGraph: {
    title: "Formaldehyde | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Formaldehyde - Some Important Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and illus",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-12-aldehydes-ketones-and-carboxylic-acids/some-important-aldehydes-and-ketones" className="text-neutral-400 hover:text-white transition">{"Some Important Aldehydes and Ketones"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Formaldehyde"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Formaldehyde"}</h1>
