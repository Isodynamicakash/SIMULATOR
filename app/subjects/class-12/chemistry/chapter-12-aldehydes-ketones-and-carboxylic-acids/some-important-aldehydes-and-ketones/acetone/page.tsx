...
export const metadata = {
  title: "Acetone | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
  description: "Acetone - Some Important Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and illustrati",
  openGraph: {
    title: "Acetone | Chapter 12: Aldehydes, Ketones and Carboxylic Acids | Class 12 Chemistry",
    description: "Acetone - Some Important Aldehydes and Ketones, Chapter 12: Aldehydes, Ketones and Carboxylic Acids. Class 12 Chemistry notes and illustrati",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Acetone"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Acetone"}</h1>
