...
export const metadata = {
  title: "Importance of Diazonium Salts in Synthesis of Arom | Chapter 13: Amines | Class 12 Chemistry",
  description: "Importance of Diazonium Salts in Synthesis of Aromatic Compounds - Chapter 13: Amines. Class 12 Chemistry.",
  openGraph: {
    title: "Importance of Diazonium Salts in Synthesis of Arom | Chapter 13: Amines | Class 12 Chemistry",
    description: "Importance of Diazonium Salts in Synthesis of Aromatic Compounds - Chapter 13: Amines. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Importance of Diazonium Salts in Synthesis of Aromatic Compounds"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Importance of Diazonium Salts in Synthesis of Aromatic Compounds"}</h1>
