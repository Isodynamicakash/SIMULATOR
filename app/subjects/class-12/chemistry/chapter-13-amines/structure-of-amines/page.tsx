...
export const metadata = {
  title: "Structure of Amines | Chapter 13: Amines | Class 12 Chemistry",
  description: "Structure of Amines - Chapter 13: Amines. Class 12 Chemistry.",
  openGraph: {
    title: "Structure of Amines | Chapter 13: Amines | Class 12 Chemistry",
    description: "Structure of Amines - Chapter 13: Amines. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Structure of Amines"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Structure of Amines"}</h1>
