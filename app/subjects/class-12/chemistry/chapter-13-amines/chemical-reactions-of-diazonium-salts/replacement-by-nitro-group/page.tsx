...
export const metadata = {
  title: "Replacement by Nitro Group | Chapter 13: Amines | Class 12 Chemistry",
  description: "Replacement by Nitro Group - Chemical Reactions of Diazonium Salts, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Replacement by Nitro Group | Chapter 13: Amines | Class 12 Chemistry",
    description: "Replacement by Nitro Group - Chemical Reactions of Diazonium Salts, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Replacement by Nitro Group"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Replacement by Nitro Group"}</h1>
