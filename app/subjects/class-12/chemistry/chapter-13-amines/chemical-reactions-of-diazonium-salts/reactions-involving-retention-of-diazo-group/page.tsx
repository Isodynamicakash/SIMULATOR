...
export const metadata = {
  title: "Reactions Involving Retention of Diazo Group | Chapter 13: Amines | Class 12 Chemistry",
  description: "Reactions Involving Retention of Diazo Group - Chemical Reactions of Diazonium Salts, Chapter 13: Amines. Class 12 Chemistry notes and illus",
  openGraph: {
    title: "Reactions Involving Retention of Diazo Group | Chapter 13: Amines | Class 12 Chemistry",
    description: "Reactions Involving Retention of Diazo Group - Chemical Reactions of Diazonium Salts, Chapter 13: Amines. Class 12 Chemistry notes and illus",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reactions Involving Retention of Diazo Group"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reactions Involving Retention of Diazo Group"}</h1>
