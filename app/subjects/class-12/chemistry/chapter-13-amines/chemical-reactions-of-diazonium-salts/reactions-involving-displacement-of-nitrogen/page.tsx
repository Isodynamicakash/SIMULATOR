...
export const metadata = {
  title: "Reactions Involving Displacement of Nitrogen | Chapter 13: Amines | Class 12 Chemistry",
  description: "Reactions Involving Displacement of Nitrogen - Chemical Reactions of Diazonium Salts, Chapter 13: Amines. Class 12 Chemistry notes and illus",
  openGraph: {
    title: "Reactions Involving Displacement of Nitrogen | Chapter 13: Amines | Class 12 Chemistry",
    description: "Reactions Involving Displacement of Nitrogen - Chemical Reactions of Diazonium Salts, Chapter 13: Amines. Class 12 Chemistry notes and illus",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reactions Involving Displacement of Nitrogen"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reactions Involving Displacement of Nitrogen"}</h1>
