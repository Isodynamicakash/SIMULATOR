...
export const metadata = {
  title: "Gattermann Reaction | Chapter 13: Amines | Class 12 Chemistry",
  description: "Gattermann Reaction - Chemical Reactions of Diazonium Salts, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Gattermann Reaction | Chapter 13: Amines | Class 12 Chemistry",
    description: "Gattermann Reaction - Chemical Reactions of Diazonium Salts, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Gattermann Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Gattermann Reaction"}</h1>
