...
export const metadata = {
  title: "Sandmeyer Reaction | Chapter 13: Amines | Class 12 Chemistry",
  description: "Sandmeyer Reaction - Chemical Reactions of Diazonium Salts, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Sandmeyer Reaction | Chapter 13: Amines | Class 12 Chemistry",
    description: "Sandmeyer Reaction - Chemical Reactions of Diazonium Salts, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Sandmeyer Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Sandmeyer Reaction"}</h1>
