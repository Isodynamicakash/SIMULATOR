...
export const metadata = {
  title: "Reduction of Amides | Chapter 13: Amines | Class 12 Chemistry",
  description: "Reduction of Amides - Preparation of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Reduction of Amides | Chapter 13: Amines | Class 12 Chemistry",
    description: "Reduction of Amides - Preparation of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reduction of Amides"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reduction of Amides"}</h1>
