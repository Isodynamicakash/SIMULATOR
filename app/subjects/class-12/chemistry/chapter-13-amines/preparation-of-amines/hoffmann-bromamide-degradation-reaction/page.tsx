...
export const metadata = {
  title: "Hoffmann Bromamide Degradation Reaction | Chapter 13: Amines | Class 12 Chemistry",
  description: "Hoffmann Bromamide Degradation Reaction - Preparation of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Hoffmann Bromamide Degradation Reaction | Chapter 13: Amines | Class 12 Chemistry",
    description: "Hoffmann Bromamide Degradation Reaction - Preparation of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-13-amines/preparation-of-amines" className="text-neutral-400 hover:text-white transition">{"Preparation of Amines"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Hoffmann Bromamide Degradation Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Hoffmann Bromamide Degradation Reaction"}</h1>
