...
export const metadata = {
  title: "Ammonolysis of Alkyl Halides | Chapter 13: Amines | Class 12 Chemistry",
  description: "Ammonolysis of Alkyl Halides - Preparation of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Ammonolysis of Alkyl Halides | Chapter 13: Amines | Class 12 Chemistry",
    description: "Ammonolysis of Alkyl Halides - Preparation of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Ammonolysis of Alkyl Halides"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Ammonolysis of Alkyl Halides"}</h1>
