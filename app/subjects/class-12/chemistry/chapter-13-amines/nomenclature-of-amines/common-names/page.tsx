...
export const metadata = {
  title: "Common Names | Chapter 13: Amines | Class 12 Chemistry",
  description: "Common Names - Nomenclature of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Common Names | Chapter 13: Amines | Class 12 Chemistry",
    description: "Common Names - Nomenclature of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-13-amines/nomenclature-of-amines" className="text-neutral-400 hover:text-white transition">{"Nomenclature of Amines"}</Link>
        <span className="text-neutral-600">/</span>
