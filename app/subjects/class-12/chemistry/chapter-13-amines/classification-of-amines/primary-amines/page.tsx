...
export const metadata = {
  title: "Primary Amines | Chapter 13: Amines | Class 12 Chemistry",
  description: "Primary Amines - Classification of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Primary Amines | Chapter 13: Amines | Class 12 Chemistry",
    description: "Primary Amines - Classification of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Primary Amines"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Primary Amines"}</h1>
