...
export const metadata = {
  title: "Aliphatic and Aromatic Amines | Chapter 13: Amines | Class 12 Chemistry",
  description: "Aliphatic and Aromatic Amines - Classification of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Aliphatic and Aromatic Amines | Chapter 13: Amines | Class 12 Chemistry",
    description: "Aliphatic and Aromatic Amines - Classification of Amines, Chapter 13: Amines. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-13-amines/classification-of-amines" className="text-neutral-400 hover:text-white transition">{"Classification of Amines"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Aliphatic and Aromatic Amines"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Aliphatic and Aromatic Amines"}</h1>
