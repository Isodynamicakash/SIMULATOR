...
export const metadata = {
  title: "Phosphorous Acid (H₃PO₃) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Phosphorous Acid (H₃PO₃) - Oxoacids of Phosphorus, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Phosphorous Acid (H₃PO₃) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Phosphorous Acid (H₃PO₃) - Oxoacids of Phosphorus, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-7-the-p-block-elements/oxoacids-of-phosphorus" className="text-neutral-400 hover:text-white transition">{"Oxoacids of Phosphorus"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Phosphorous Acid (H₃PO₃)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Phosphorous Acid (H₃PO₃)"}</h1>
