...
export const metadata = {
  title: "Phosphoric Acid (H₃PO₄) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Phosphoric Acid (H₃PO₄) - Oxoacids of Phosphorus, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Phosphoric Acid (H₃PO₄) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Phosphoric Acid (H₃PO₄) - Oxoacids of Phosphorus, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Phosphoric Acid (H₃PO₄)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Phosphoric Acid (H₃PO₄)"}</h1>
