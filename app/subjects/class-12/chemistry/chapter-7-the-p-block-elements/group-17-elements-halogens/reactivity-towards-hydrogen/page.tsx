...
export const metadata = {
  title: "Reactivity towards Hydrogen | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Reactivity towards Hydrogen - Group 17 Elements (Halogens), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Reactivity towards Hydrogen | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Reactivity towards Hydrogen - Group 17 Elements (Halogens), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reactivity towards Hydrogen"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reactivity towards Hydrogen"}</h1>
