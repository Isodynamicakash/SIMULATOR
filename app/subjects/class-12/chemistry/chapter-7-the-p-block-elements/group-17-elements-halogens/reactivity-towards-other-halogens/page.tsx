...
export const metadata = {
  title: "Reactivity towards Other Halogens | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Reactivity towards Other Halogens - Group 17 Elements (Halogens), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustration",
  openGraph: {
    title: "Reactivity towards Other Halogens | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Reactivity towards Other Halogens - Group 17 Elements (Halogens), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustration",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-7-the-p-block-elements/group-17-elements-halogens" className="text-neutral-400 hover:text-white transition">{"Group 17 Elements (Halogens)"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reactivity towards Other Halogens"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reactivity towards Other Halogens"}</h1>
