...
export const metadata = {
  title: "Uses | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Uses - Hydrogen Chloride, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Uses | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Uses - Hydrogen Chloride, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Uses"}</h1>
