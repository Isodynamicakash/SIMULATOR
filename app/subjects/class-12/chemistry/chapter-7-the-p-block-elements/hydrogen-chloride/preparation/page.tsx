...
export const metadata = {
  title: "Preparation | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Preparation - Hydrogen Chloride, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Preparation | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Preparation - Hydrogen Chloride, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-7-the-p-block-elements/hydrogen-chloride" className="text-neutral-400 hover:text-white transition">{"Hydrogen Chloride"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Preparation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Preparation"}</h1>
