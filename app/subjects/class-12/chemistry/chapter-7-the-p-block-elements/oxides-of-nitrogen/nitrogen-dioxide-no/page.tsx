...
export const metadata = {
  title: "Nitrogen Dioxide (NO₂) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Nitrogen Dioxide (NO₂) - Oxides of Nitrogen, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Nitrogen Dioxide (NO₂) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Nitrogen Dioxide (NO₂) - Oxides of Nitrogen, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Nitrogen Dioxide (NO₂)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Nitrogen Dioxide (NO₂)"}</h1>
