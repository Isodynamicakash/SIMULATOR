...
export const metadata = {
  title: "Dinitrogen Pentoxide (N₂O₅) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Dinitrogen Pentoxide (N₂O₅) - Oxides of Nitrogen, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Dinitrogen Pentoxide (N₂O₅) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Dinitrogen Pentoxide (N₂O₅) - Oxides of Nitrogen, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-7-the-p-block-elements/oxides-of-nitrogen" className="text-neutral-400 hover:text-white transition">{"Oxides of Nitrogen"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Dinitrogen Pentoxide (N₂O₅)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Dinitrogen Pentoxide (N₂O₅)"}</h1>
