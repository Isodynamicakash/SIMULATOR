...
export const metadata = {
  title: "Nitrous Oxide (N₂O) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Nitrous Oxide (N₂O) - Oxides of Nitrogen, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Nitrous Oxide (N₂O) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Nitrous Oxide (N₂O) - Oxides of Nitrogen, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Nitrous Oxide (N₂O)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Nitrous Oxide (N₂O)"}</h1>
