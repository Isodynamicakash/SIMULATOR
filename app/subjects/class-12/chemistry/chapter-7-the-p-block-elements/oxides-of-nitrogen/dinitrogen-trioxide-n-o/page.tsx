...
export const metadata = {
  title: "Dinitrogen Trioxide (N₂O₃) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Dinitrogen Trioxide (N₂O₃) - Oxides of Nitrogen, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Dinitrogen Trioxide (N₂O₃) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Dinitrogen Trioxide (N₂O₃) - Oxides of Nitrogen, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Dinitrogen Trioxide (N₂O₃)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Dinitrogen Trioxide (N₂O₃)"}</h1>
