...
export const metadata = {
  title: "Atomic Radii | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Atomic Radii - Group 18 Elements (Noble Gases), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Atomic Radii | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Atomic Radii - Group 18 Elements (Noble Gases), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Atomic Radii"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Atomic Radii"}</h1>
