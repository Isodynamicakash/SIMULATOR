...
export const metadata = {
  title: "Xenon Oxyfluorides | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Xenon Oxyfluorides - Compounds of Xenon, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Xenon Oxyfluorides | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Xenon Oxyfluorides - Compounds of Xenon, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-7-the-p-block-elements/compounds-of-xenon" className="text-neutral-400 hover:text-white transition">{"Compounds of Xenon"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Xenon Oxyfluorides"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Xenon Oxyfluorides"}</h1>
