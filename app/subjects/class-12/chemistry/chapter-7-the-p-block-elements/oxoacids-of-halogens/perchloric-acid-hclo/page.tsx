...
export const metadata = {
  title: "Perchloric Acid (HClO₄) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Perchloric Acid (HClO₄) - Oxoacids of Halogens, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Perchloric Acid (HClO₄) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Perchloric Acid (HClO₄) - Oxoacids of Halogens, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Perchloric Acid (HClO₄)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Perchloric Acid (HClO₄)"}</h1>
