...
export const metadata = {
  title: "Hypochlorous Acid (HOCl) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Hypochlorous Acid (HOCl) - Oxoacids of Halogens, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Hypochlorous Acid (HOCl) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Hypochlorous Acid (HOCl) - Oxoacids of Halogens, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-7-the-p-block-elements/oxoacids-of-halogens" className="text-neutral-400 hover:text-white transition">{"Oxoacids of Halogens"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Hypochlorous Acid (HOCl)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Hypochlorous Acid (HOCl)"}</h1>
