...
export const metadata = {
  title: "Chloric Acid (HClO₃) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Chloric Acid (HClO₃) - Oxoacids of Halogens, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Chloric Acid (HClO₃) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Chloric Acid (HClO₃) - Oxoacids of Halogens, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Chloric Acid (HClO₃)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Chloric Acid (HClO₃)"}</h1>
