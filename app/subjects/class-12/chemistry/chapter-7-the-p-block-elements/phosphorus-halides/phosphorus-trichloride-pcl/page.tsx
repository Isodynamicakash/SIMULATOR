...
export const metadata = {
  title: "Phosphorus Trichloride (PCl₃) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Phosphorus Trichloride (PCl₃) - Phosphorus Halides, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Phosphorus Trichloride (PCl₃) | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Phosphorus Trichloride (PCl₃) - Phosphorus Halides, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Phosphorus Trichloride (PCl₃)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Phosphorus Trichloride (PCl₃)"}</h1>
