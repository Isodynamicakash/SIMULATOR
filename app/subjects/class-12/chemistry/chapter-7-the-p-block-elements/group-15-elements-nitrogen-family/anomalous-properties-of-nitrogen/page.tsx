...
export const metadata = {
  title: "Anomalous Properties of Nitrogen | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Anomalous Properties of Nitrogen - Group 15 Elements (Nitrogen Family), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illust",
  openGraph: {
    title: "Anomalous Properties of Nitrogen | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Anomalous Properties of Nitrogen - Group 15 Elements (Nitrogen Family), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illust",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Anomalous Properties of Nitrogen"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Anomalous Properties of Nitrogen"}</h1>
