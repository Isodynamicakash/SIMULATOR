...
export const metadata = {
  title: "Reactivity towards Halogens | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Reactivity towards Halogens - Group 15 Elements (Nitrogen Family), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustratio",
  openGraph: {
    title: "Reactivity towards Halogens | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Reactivity towards Halogens - Group 15 Elements (Nitrogen Family), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustratio",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reactivity towards Halogens"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reactivity towards Halogens"}</h1>
