...
export const metadata = {
  title: "Simple Oxides | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Simple Oxides - Chapter 7: The p-Block Elements. Class 12 Chemistry.",
  openGraph: {
    title: "Simple Oxides | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Simple Oxides - Chapter 7: The p-Block Elements. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Simple Oxides"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Simple Oxides"}</h1>
