...
export const metadata = {
  title: "Reactivity with Halogens | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Reactivity with Halogens - Group 16 Elements (Oxygen Family), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Reactivity with Halogens | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Reactivity with Halogens - Group 16 Elements (Oxygen Family), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reactivity with Halogens"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reactivity with Halogens"}</h1>
