...
export const metadata = {
  title: "Anomalous Behaviour of Oxygen | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Anomalous Behaviour of Oxygen - Group 16 Elements (Oxygen Family), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustratio",
  openGraph: {
    title: "Anomalous Behaviour of Oxygen | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Anomalous Behaviour of Oxygen - Group 16 Elements (Oxygen Family), Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustratio",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-7-the-p-block-elements/group-16-elements-oxygen-family" className="text-neutral-400 hover:text-white transition">{"Group 16 Elements (Oxygen Family)"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Anomalous Behaviour of Oxygen"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Anomalous Behaviour of Oxygen"}</h1>
