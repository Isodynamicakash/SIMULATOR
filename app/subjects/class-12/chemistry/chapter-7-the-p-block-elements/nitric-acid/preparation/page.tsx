...
export const metadata = {
  ...
  description: "Preparation - Nitric Acid, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Preparation | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Preparation - Nitric Acid, Chapter 7: The p-Block Elements. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-7-the-p-block-elements/nitric-acid" className="text-neutral-400 hover:text-white transition">{"Nitric Acid"}</Link>
        <span className="text-neutral-600">/</span>
