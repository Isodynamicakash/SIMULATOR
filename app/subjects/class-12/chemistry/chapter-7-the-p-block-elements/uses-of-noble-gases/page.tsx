...
export const metadata = {
  title: "Uses of Noble Gases | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Uses of Noble Gases - Chapter 7: The p-Block Elements. Class 12 Chemistry.",
  openGraph: {
    title: "Uses of Noble Gases | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Uses of Noble Gases - Chapter 7: The p-Block Elements. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Uses of Noble Gases"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Uses of Noble Gases"}</h1>
