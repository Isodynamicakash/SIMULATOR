...
export const metadata = {
  title: "Phosphine | Chapter 7: The p-Block Elements | Class 12 Chemistry",
  description: "Phosphine - Chapter 7: The p-Block Elements. Class 12 Chemistry.",
  openGraph: {
    title: "Phosphine | Chapter 7: The p-Block Elements | Class 12 Chemistry",
    description: "Phosphine - Chapter 7: The p-Block Elements. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Phosphine"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Phosphine"}</h1>
<p className="mt-2 text-neutral-400">Choose a subtopic.</p>
        <div className="mt-8 grid gap-3 md:grid-cols-2">
            <Link href="/subjects/class-12/chemistry/chapter-7-the-p-block-elements/phosphine/preparation" className="group rounded-2xl border border-neutral-800 bg-neutral-950/70 p-4 transition hover:-translate-y-0.5 hover:border-neutral-600 hover:bg-neutral-900">
            ...
            <Link href="/subjects/class-12/chemistry/chapter-7-the-p-block-elements/phosphine/properties" className="group rounded-2xl border border-neutral-800 bg-neutral-950/70 p-4 transition hover:-translate-y-0.5 hover:border-neutral-600 hover:bg-neutral-900">
