...
export const metadata = {
  title: "Molecular Solids | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Molecular Solids - Classification of Crystalline Solids, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Molecular Solids | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Molecular Solids - Classification of Crystalline Solids, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Molecular Solids"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Molecular Solids"}</h1>
