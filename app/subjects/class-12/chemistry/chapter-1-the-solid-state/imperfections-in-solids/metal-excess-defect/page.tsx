...
export const metadata = {
  title: "Metal Excess Defect | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Metal Excess Defect - Imperfections in Solids, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Metal Excess Defect | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Metal Excess Defect - Imperfections in Solids, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Metal Excess Defect"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Metal Excess Defect"}</h1>
