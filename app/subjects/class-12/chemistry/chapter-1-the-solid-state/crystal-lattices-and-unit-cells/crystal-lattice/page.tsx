...
export const metadata = {
  title: "Crystal Lattice | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Crystal Lattice - Crystal Lattices and Unit Cells, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Crystal Lattice | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Crystal Lattice - Crystal Lattices and Unit Cells, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Crystal Lattice"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Crystal Lattice"}</h1>
