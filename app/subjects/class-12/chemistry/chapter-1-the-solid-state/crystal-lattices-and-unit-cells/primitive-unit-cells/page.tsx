...
export const metadata = {
  title: "Primitive Unit Cells | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Primitive Unit Cells - Crystal Lattices and Unit Cells, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Primitive Unit Cells | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Primitive Unit Cells - Crystal Lattices and Unit Cells, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-1-the-solid-state/crystal-lattices-and-unit-cells" className="text-neutral-400 hover:text-white transition">{"Crystal Lattices and Unit Cells"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Primitive Unit Cells"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Primitive Unit Cells"}</h1>
