...
export const metadata = {
  title: "Types of Unit Cells | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Types of Unit Cells - Crystal Lattices and Unit Cells, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Types of Unit Cells | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Types of Unit Cells - Crystal Lattices and Unit Cells, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Types of Unit Cells"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Types of Unit Cells"}</h1>
