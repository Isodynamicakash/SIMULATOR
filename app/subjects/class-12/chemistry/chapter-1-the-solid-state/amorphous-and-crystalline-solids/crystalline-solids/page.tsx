...
export const metadata = {
  title: "Crystalline Solids | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Crystalline Solids - Amorphous and Crystalline Solids, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Crystalline Solids | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Crystalline Solids - Amorphous and Crystalline Solids, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Crystalline Solids"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Crystalline Solids"}</h1>
