...
export const metadata = {
  title: "Semiconductors | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Semiconductors - Electrical Properties, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Semiconductors | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Semiconductors - Electrical Properties, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-1-the-solid-state/electrical-properties" className="text-neutral-400 hover:text-white transition">{"Electrical Properties"}</Link>
        <span className="text-neutral-600">/</span>
