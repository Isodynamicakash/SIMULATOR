...
export const metadata = {
  title: "Body-Centred Cubic Unit Cell | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Body-Centred Cubic Unit Cell - Number of Atoms in a Unit Cell, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Body-Centred Cubic Unit Cell | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Body-Centred Cubic Unit Cell - Number of Atoms in a Unit Cell, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Body-Centred Cubic Unit Cell"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Body-Centred Cubic Unit Cell"}</h1>
