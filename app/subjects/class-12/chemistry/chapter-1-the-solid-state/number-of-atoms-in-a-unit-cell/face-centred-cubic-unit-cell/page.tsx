...
export const metadata = {
  title: "Face-Centred Cubic Unit Cell | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Face-Centred Cubic Unit Cell - Number of Atoms in a Unit Cell, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Face-Centred Cubic Unit Cell | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Face-Centred Cubic Unit Cell - Number of Atoms in a Unit Cell, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-1-the-solid-state/number-of-atoms-in-a-unit-cell" className="text-neutral-400 hover:text-white transition">{"Number of Atoms in a Unit Cell"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Face-Centred Cubic Unit Cell"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Face-Centred Cubic Unit Cell"}</h1>
