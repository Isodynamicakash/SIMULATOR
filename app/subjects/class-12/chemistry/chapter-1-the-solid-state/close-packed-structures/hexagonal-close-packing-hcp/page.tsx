...
export const metadata = {
  title: "Hexagonal Close Packing (hcp) | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Hexagonal Close Packing (hcp) - Close Packed Structures, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Hexagonal Close Packing (hcp) | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Hexagonal Close Packing (hcp) - Close Packed Structures, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Hexagonal Close Packing (hcp)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Hexagonal Close Packing (hcp)"}</h1>
