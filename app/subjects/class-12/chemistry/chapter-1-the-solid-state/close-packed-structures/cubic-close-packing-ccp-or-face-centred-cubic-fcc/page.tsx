...
export const metadata = {
  title: "Cubic Close Packing (ccp) or Face-Centred Cubic (f | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Cubic Close Packing (ccp) or Face-Centred Cubic (fcc) - Close Packed Structures, Chapter 1: The Solid State. Class 12 Chemistry notes and il",
  openGraph: {
    title: "Cubic Close Packing (ccp) or Face-Centred Cubic (f | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Cubic Close Packing (ccp) or Face-Centred Cubic (fcc) - Close Packed Structures, Chapter 1: The Solid State. Class 12 Chemistry notes and il",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Cubic Close Packing (ccp) or Face-Centred Cubic (fcc)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Cubic Close Packing (ccp) or Face-Centred Cubic (fcc)"}</h1>
