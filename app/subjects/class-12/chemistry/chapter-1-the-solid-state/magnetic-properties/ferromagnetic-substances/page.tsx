...
export const metadata = {
  title: "Ferromagnetic Substances | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Ferromagnetic Substances - Magnetic Properties, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Ferromagnetic Substances | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Ferromagnetic Substances - Magnetic Properties, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Ferromagnetic Substances"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Ferromagnetic Substances"}</h1>
