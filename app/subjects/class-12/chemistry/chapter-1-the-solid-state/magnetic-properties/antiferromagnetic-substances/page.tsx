...
export const metadata = {
  title: "Antiferromagnetic Substances | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Antiferromagnetic Substances - Magnetic Properties, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Antiferromagnetic Substances | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Antiferromagnetic Substances - Magnetic Properties, Chapter 1: The Solid State. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-1-the-solid-state/magnetic-properties" className="text-neutral-400 hover:text-white transition">{"Magnetic Properties"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Antiferromagnetic Substances"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Antiferromagnetic Substances"}</h1>
