...
export const metadata = {
  title: "Calculations Involving Unit Cell Dimensions | Chapter 1: The Solid State | Class 12 Chemistry",
  description: "Calculations Involving Unit Cell Dimensions - Chapter 1: The Solid State. Class 12 Chemistry.",
  openGraph: {
    title: "Calculations Involving Unit Cell Dimensions | Chapter 1: The Solid State | Class 12 Chemistry",
    description: "Calculations Involving Unit Cell Dimensions - Chapter 1: The Solid State. Class 12 Chemistry.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Calculations Involving Unit Cell Dimensions"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Calculations Involving Unit Cell Dimensions"}</h1>
