...
export const metadata = {
  title: "Peptide Hormones | Chapter 14: Biomolecules | Class 12 Chemistry",
  description: "Peptide Hormones - Hormones, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Peptide Hormones | Chapter 14: Biomolecules | Class 12 Chemistry",
    description: "Peptide Hormones - Hormones, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Peptide Hormones"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Peptide Hormones"}</h1>
