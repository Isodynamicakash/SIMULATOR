...
export const metadata = {
  title: "Classification of Hormones | Chapter 14: Biomolecules | Class 12 Chemistry",
  description: "Classification of Hormones - Hormones, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Classification of Hormones | Chapter 14: Biomolecules | Class 12 Chemistry",
    description: "Classification of Hormones - Hormones, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-14-biomolecules/hormones" className="text-neutral-400 hover:text-white transition">{"Hormones"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Classification of Hormones"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Classification of Hormones"}</h1>
