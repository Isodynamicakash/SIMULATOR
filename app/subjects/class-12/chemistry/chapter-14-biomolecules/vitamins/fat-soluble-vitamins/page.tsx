...
export const metadata = {
  title: "Fat Soluble Vitamins | Chapter 14: Biomolecules | Class 12 Chemistry",
  description: "Fat Soluble Vitamins - Vitamins, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Fat Soluble Vitamins | Chapter 14: Biomolecules | Class 12 Chemistry",
    description: "Fat Soluble Vitamins - Vitamins, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Fat Soluble Vitamins"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Fat Soluble Vitamins"}</h1>
