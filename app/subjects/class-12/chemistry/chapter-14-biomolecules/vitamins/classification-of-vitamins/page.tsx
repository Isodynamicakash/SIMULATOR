...
export const metadata = {
  title: "Classification of Vitamins | Chapter 14: Biomolecules | Class 12 Chemistry",
  description: "Classification of Vitamins - Vitamins, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Classification of Vitamins | Chapter 14: Biomolecules | Class 12 Chemistry",
    description: "Classification of Vitamins - Vitamins, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-14-biomolecules/vitamins" className="text-neutral-400 hover:text-white transition">{"Vitamins"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Classification of Vitamins"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Classification of Vitamins"}</h1>
