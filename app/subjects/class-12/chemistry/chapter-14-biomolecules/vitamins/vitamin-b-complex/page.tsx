...
export const metadata = {
  title: "Vitamin B Complex | Chapter 14: Biomolecules | Class 12 Chemistry",
  description: "Vitamin B Complex - Vitamins, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Vitamin B Complex | Chapter 14: Biomolecules | Class 12 Chemistry",
    description: "Vitamin B Complex - Vitamins, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Vitamin B Complex"}</h1>
