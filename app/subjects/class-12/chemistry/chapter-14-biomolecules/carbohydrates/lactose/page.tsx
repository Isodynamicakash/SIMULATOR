...
export const metadata = {
  title: "Lactose | Chapter 14: Biomolecules | Class 12 Chemistry",
  description: "Lactose - Carbohydrates, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Lactose | Chapter 14: Biomolecules | Class 12 Chemistry",
    description: "Lactose - Carbohydrates, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Lactose"}</h1>
