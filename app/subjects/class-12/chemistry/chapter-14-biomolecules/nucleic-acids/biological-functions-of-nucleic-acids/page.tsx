...
export const metadata = {
  title: "Biological Functions of Nucleic Acids | Chapter 14: Biomolecules | Class 12 Chemistry",
  description: "Biological Functions of Nucleic Acids - Nucleic Acids, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  openGraph: {
    title: "Biological Functions of Nucleic Acids | Chapter 14: Biomolecules | Class 12 Chemistry",
    description: "Biological Functions of Nucleic Acids - Nucleic Acids, Chapter 14: Biomolecules. Class 12 Chemistry notes and illustrations.",
  },
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-12/chemistry/chapter-14-biomolecules/nucleic-acids" className="text-neutral-400 hover:text-white transition">{"Nucleic Acids"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Biological Functions of Nucleic Acids"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Biological Functions of Nucleic Acids"}</h1>
