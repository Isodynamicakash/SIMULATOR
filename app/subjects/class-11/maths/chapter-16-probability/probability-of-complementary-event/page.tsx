  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Probability of Complementary Event"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Probability of Complementary Event"}</h1>
