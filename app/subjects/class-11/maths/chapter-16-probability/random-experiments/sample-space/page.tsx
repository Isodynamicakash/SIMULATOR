  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-16-probability/random-experiments" className="text-neutral-400 hover:text-white transition">{"Random Experiments"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Sample Space"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Sample Space"}</h1>
