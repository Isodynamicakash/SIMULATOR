  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-10-straight-lines/equation-of-family-of-lines" className="text-neutral-400 hover:text-white transition">{"Equation of Family of Lines"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Equation of Lines Passing through Point of Intersection"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Equation of Lines Passing through Point of Intersection"}</h1>
