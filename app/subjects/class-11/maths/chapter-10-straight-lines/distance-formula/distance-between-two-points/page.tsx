  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-10-straight-lines/distance-formula" className="text-neutral-400 hover:text-white transition">{"Distance Formula"}</Link>
        <span className="text-neutral-600">/</span>
