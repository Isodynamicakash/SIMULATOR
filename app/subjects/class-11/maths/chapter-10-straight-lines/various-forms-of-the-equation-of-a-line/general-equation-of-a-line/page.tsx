  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-10-straight-lines/various-forms-of-the-equation-of-a-line" className="text-neutral-400 hover:text-white transition">{"Various Forms of the Equation of a Line"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"General Equation of a Line"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"General Equation of a Line"}</h1>
