  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-5-complex-numbers-and-quadratic-equations/argand-plane-and-polar-representation" className="text-neutral-400 hover:text-white transition">{"Argand Plane and Polar Representation"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Polar Form of Complex Numbers"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Polar Form of Complex Numbers"}</h1>
