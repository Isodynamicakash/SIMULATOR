  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-5-complex-numbers-and-quadratic-equations/quadratic-equations" className="text-neutral-400 hover:text-white transition">{"Quadratic Equations"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Formation of Quadratic Equation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Formation of Quadratic Equation"}</h1>
