  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-5-complex-numbers-and-quadratic-equations/algebra-of-complex-numbers" className="text-neutral-400 hover:text-white transition">{"Algebra of Complex Numbers"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Multiplication of Complex Numbers"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Multiplication of Complex Numbers"}</h1>
