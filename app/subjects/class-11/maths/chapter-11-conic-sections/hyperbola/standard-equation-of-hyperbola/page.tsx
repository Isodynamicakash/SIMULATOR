  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-11-conic-sections/hyperbola" className="text-neutral-400 hover:text-white transition">{"Hyperbola"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Standard Equation of Hyperbola"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Standard Equation of Hyperbola"}</h1>
