  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-11-conic-sections/ellipse" className="text-neutral-400 hover:text-white transition">{"Ellipse"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Relationship between a, b and e"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Relationship between a, b and e"}</h1>
