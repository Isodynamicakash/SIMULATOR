  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-12-introduction-to-three-dimensional-geometry/distance-formula-in-three-dimensions" className="text-neutral-400 hover:text-white transition">{"Distance Formula in Three Dimensions"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Distance between Two Points"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Distance between Two Points"}</h1>
