  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Distance Formula in Three Dimensions"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Distance Formula in Three Dimensions"}</h1>
<p className="mt-2 text-neutral-400">Choose a subtopic.</p>
        <div className="mt-8 grid gap-3 md:grid-cols-2">
            <Link href="/subjects/class-11/maths/chapter-12-introduction-to-three-dimensional-geometry/distance-formula-in-three-dimensions/distance-between-two-points" className="group rounded-2xl border border-neutral-800 bg-neutral-950/70 p-4 transition hover:-translate-y-0.5 hover:border-neutral-600 hover:bg-neutral-900">
