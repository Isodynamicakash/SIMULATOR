  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-12-introduction-to-three-dimensional-geometry/coordinates-of-a-point-in-space" className="text-neutral-400 hover:text-white transition">{"Coordinates of a Point in Space"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Signs of Coordinates in Different Octants"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Signs of Coordinates in Different Octants"}</h1>
