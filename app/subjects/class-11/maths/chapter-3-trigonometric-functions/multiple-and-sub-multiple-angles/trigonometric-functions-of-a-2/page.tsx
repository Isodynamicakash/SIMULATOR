  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-3-trigonometric-functions/multiple-and-sub-multiple-angles" className="text-neutral-400 hover:text-white transition">{"Multiple and Sub-multiple Angles"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Trigonometric Functions of A/2"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Trigonometric Functions of A/2"}</h1>
