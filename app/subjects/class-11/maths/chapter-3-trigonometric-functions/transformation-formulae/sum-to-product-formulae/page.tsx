  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/maths/chapter-3-trigonometric-functions/transformation-formulae" className="text-neutral-400 hover:text-white transition">{"Transformation Formulae"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Sum to Product Formulae"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Sum to Product Formulae"}</h1>
