  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-9-hydrogen/hydrogen-peroxide-h-o" className="text-neutral-400 hover:text-white transition">{"Hydrogen Peroxide (H₂O₂)"}</Link>
        <span className="text-neutral-600">/</span>
