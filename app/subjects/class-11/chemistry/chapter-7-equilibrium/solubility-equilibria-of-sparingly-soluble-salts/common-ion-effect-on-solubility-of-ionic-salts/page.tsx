  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-7-equilibrium/solubility-equilibria-of-sparingly-soluble-salts" className="text-neutral-400 hover:text-white transition">{"Solubility Equilibria of Sparingly Soluble Salts"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Common Ion Effect on Solubility of Ionic Salts"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Common Ion Effect on Solubility of Ionic Salts"}</h1>
