  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-7-equilibrium/applications-of-equilibrium-constants" className="text-neutral-400 hover:text-white transition">{"Applications of Equilibrium Constants"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Predicting the Direction of the Reaction"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Predicting the Direction of the Reaction"}</h1>
