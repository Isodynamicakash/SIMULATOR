  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-7-equilibrium/homogeneous-equilibria" className="text-neutral-400 hover:text-white transition">{"Homogeneous Equilibria"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Equilibrium Constant in Gaseous Systems"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Equilibrium Constant in Gaseous Systems"}</h1>
