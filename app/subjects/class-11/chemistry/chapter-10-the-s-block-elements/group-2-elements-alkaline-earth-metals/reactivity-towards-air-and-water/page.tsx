  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-10-the-s-block-elements/group-2-elements-alkaline-earth-metals" className="text-neutral-400 hover:text-white transition">{"Group 2 Elements: Alkaline Earth Metals"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reactivity towards Air and Water"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reactivity towards Air and Water"}</h1>
