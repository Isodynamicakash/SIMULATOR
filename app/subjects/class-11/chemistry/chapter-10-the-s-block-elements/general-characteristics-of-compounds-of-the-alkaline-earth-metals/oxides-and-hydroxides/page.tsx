  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-10-the-s-block-elements/general-characteristics-of-compounds-of-the-alkaline-earth-metals" className="text-neutral-400 hover:text-white transition">{"General Characteristics of Compounds of the Alkaline Earth Metals"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Oxides and Hydroxides"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Oxides and Hydroxides"}</h1>
