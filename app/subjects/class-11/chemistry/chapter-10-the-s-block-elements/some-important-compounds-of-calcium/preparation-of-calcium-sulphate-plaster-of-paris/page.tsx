  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-10-the-s-block-elements/some-important-compounds-of-calcium" className="text-neutral-400 hover:text-white transition">{"Some Important Compounds of Calcium"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Preparation of Calcium Sulphate (Plaster of Paris)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Preparation of Calcium Sulphate (Plaster of Paris)"}</h1>
