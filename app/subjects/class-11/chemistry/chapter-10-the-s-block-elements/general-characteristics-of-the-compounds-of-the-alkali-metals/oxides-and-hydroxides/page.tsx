  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-10-the-s-block-elements/general-characteristics-of-the-compounds-of-the-alkali-metals" className="text-neutral-400 hover:text-white transition">{"General Characteristics of the Compounds of the Alkali Metals"}</Link>
        <span className="text-neutral-600">/</span>
