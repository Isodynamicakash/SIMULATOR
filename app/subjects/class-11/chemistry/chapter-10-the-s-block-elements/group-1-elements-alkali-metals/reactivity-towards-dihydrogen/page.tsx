  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-10-the-s-block-elements/group-1-elements-alkali-metals" className="text-neutral-400 hover:text-white transition">{"Group 1 Elements: Alkali Metals"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reactivity towards Dihydrogen"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reactivity towards Dihydrogen"}</h1>
