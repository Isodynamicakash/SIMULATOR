  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-1-some-basic-concepts-of-chemistry/properties-of-matter-and-their-measurement" className="text-neutral-400 hover:text-white transition">{"Properties of Matter and their Measurement"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Mass and Weight"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Mass and Weight"}</h1>
