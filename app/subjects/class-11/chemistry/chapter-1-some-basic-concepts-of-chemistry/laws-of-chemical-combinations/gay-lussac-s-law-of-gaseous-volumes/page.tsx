  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-1-some-basic-concepts-of-chemistry/laws-of-chemical-combinations" className="text-neutral-400 hover:text-white transition">{"Laws of Chemical Combinations"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Gay Lussac's Law of Gaseous Volumes"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Gay Lussac's Law of Gaseous Volumes"}</h1>
