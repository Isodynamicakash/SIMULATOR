  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-2-structure-of-atom/developments-leading-to-the-bohr-s-model-of-atom" className="text-neutral-400 hover:text-white transition">{"Developments Leading to the Bohr's Model of Atom"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Particle Nature of Electromagnetic Radiation - Planck's Quantum Theory"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Particle Nature of Electromagnetic Radiation - Planck's Quantum Theory"}</h1>
