  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-2-structure-of-atom/discovery-of-electron" className="text-neutral-400 hover:text-white transition">{"Discovery of Electron"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Cathode Ray Discharge Tube Experiment"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Cathode Ray Discharge Tube Experiment"}</h1>
