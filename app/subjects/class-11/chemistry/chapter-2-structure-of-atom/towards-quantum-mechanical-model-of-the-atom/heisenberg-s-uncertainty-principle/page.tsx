  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-2-structure-of-atom/towards-quantum-mechanical-model-of-the-atom" className="text-neutral-400 hover:text-white transition">{"Towards Quantum Mechanical Model of the Atom"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Heisenberg's Uncertainty Principle"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Heisenberg's Uncertainty Principle"}</h1>
