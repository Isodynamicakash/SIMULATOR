  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-13-hydrocarbons/alkenes" className="text-neutral-400 hover:text-white transition">{"Alkenes"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Addition of Hydrogen Halides"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Addition of Hydrogen Halides"}</h1>
