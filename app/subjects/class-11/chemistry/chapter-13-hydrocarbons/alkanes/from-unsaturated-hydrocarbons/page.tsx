  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-13-hydrocarbons/alkanes" className="text-neutral-400 hover:text-white transition">{"Alkanes"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"From Unsaturated Hydrocarbons"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"From Unsaturated Hydrocarbons"}</h1>
