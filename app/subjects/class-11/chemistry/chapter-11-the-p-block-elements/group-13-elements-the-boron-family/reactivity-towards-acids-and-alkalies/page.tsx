  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-11-the-p-block-elements/group-13-elements-the-boron-family" className="text-neutral-400 hover:text-white transition">{"Group 13 Elements: The Boron Family"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reactivity towards Acids and Alkalies"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reactivity towards Acids and Alkalies"}</h1>
