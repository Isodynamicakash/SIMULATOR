  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-4-chemical-bonding-and-molecular-structure/kossel-lewis-approach-to-chemical-bonding" className="text-neutral-400 hover:text-white transition">{"Kossel-Lewis Approach to Chemical Bonding"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Lewis Representation of Simple Molecules (Lewis Structures)"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Lewis Representation of Simple Molecules (Lewis Structures)"}</h1>
