  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-5-states-of-matter/liquid-state" className="text-neutral-400 hover:text-white transition">{"Liquid State"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Surface Tension"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Surface Tension"}</h1>
