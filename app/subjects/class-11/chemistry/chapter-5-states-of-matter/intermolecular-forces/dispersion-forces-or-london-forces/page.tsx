  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/chemistry/chapter-5-states-of-matter/intermolecular-forces" className="text-neutral-400 hover:text-white transition">{"Intermolecular Forces"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Dispersion Forces or London Forces"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Dispersion Forces or London Forces"}</h1>
