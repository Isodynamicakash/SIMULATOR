  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/biology/chapter-7-structural-organisation-in-animals/cockroach" className="text-neutral-400 hover:text-white transition">{"Cockroach"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Reproductive System"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Reproductive System"}</h1>
