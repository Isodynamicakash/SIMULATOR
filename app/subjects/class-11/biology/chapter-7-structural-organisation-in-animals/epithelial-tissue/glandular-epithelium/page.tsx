  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/biology/chapter-7-structural-organisation-in-animals/epithelial-tissue" className="text-neutral-400 hover:text-white transition">{"Epithelial Tissue"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Glandular Epithelium"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Glandular Epithelium"}</h1>
