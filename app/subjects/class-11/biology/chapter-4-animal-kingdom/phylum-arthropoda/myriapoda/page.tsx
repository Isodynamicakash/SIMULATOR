  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/biology/chapter-4-animal-kingdom/phylum-arthropoda" className="text-neutral-400 hover:text-white transition">{"Phylum Arthropoda"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Myriapoda"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Myriapoda"}</h1>
