  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/biology/chapter-18-body-fluids-and-circulation/lymph-tissue-fluid" className="text-neutral-400 hover:text-white transition">{"Lymph (Tissue Fluid)"}</Link>
        <span className="text-neutral-600">/</span>
