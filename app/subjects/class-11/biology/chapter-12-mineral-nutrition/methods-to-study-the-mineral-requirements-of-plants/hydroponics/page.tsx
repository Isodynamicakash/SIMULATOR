  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/biology/chapter-12-mineral-nutrition/methods-to-study-the-mineral-requirements-of-plants" className="text-neutral-400 hover:text-white transition">{"Methods to Study the Mineral Requirements of Plants"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Hydroponics"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Hydroponics"}</h1>
