  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/biology/chapter-6-anatomy-of-flowering-plants/isobilateral-monocotyledonous-leaf" className="text-neutral-400 hover:text-white transition">{"Isobilateral (Monocotyledonous) Leaf"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Internal Structure"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Internal Structure"}</h1>
