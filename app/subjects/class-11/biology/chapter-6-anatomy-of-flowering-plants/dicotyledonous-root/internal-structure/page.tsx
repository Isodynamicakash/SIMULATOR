  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/biology/chapter-6-anatomy-of-flowering-plants/dicotyledonous-root" className="text-neutral-400 hover:text-white transition">{"Dicotyledonous Root"}</Link>
        <span className="text-neutral-600">/</span>
