  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <nav className="flex flex-wrap items-center gap-1 text-sm mb-6">
        ...
        <span className="text-neutral-600">/</span>
        <Link href="/subjects/class-11/biology/chapter-14-respiration-in-plants/fermentation" className="text-neutral-400 hover:text-white transition">{"Fermentation"}</Link>
        <span className="text-neutral-600">/</span>
        <span className="text-white">{"Lactic Acid Fermentation"}</span>
      </nav>
        <h1 className="text-3xl font-bold tracking-tight text-white">{"Lactic Acid Fermentation"}</h1>
